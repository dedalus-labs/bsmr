...
use bsmr_build_api::query::bxl::BxlAqueryFunctions;
use bsmr_build_api::query::bxl::NEW_BXL_AQUERY_FUNCTIONS;
...
use bsmr_query::query::syntax::simple::functions::DefaultQueryFunctions;
...
impl BxlAqueryFunctionsImpl {
    ...
    ) -> bsmr_error::Result<Arc<DiceAqueryDelegate<'c, 'd>>> {
    ...
    ) -> bsmr_error::Result<AqueryEnvironment<'c>> {
        ...
        let target_sets = dice
            .try_compute_join(
                ...
                |ctx: &mut DiceComputations,
                 ...
                 -> BoxFuture<
                    bsmr_error::Result<Either<ConfiguredTargetLabel, TargetSet<ActionQueryNode>>>,
                > {
                    async move {
