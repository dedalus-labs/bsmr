...
use bsmr_node::query::query_functions::CONFIGURED_GRAPH_QUERY_FUNCTIONS;
...
use bsmr_query::query::syntax::simple::eval::values::QueryValue;
...
use bsmr_query::query::syntax::simple::functions::helpers::QueryBinaryOp;
use bsmr_query::query::syntax::simple::functions::helpers::QueryFunction;
use bsmr_query::query::traversal::NodeLookupId;
use bsmr_query::query::traversal::async_depth_limited_traversal;
use bsmr_query::query::traversal::async_fast_depth_first_postorder_traversal;
use bsmr_query::query_module;
...
pub(crate) trait ConfiguredGraphQueryEnvironmentDelegate: Send + Sync {
    fn eval_literal(&self, literal: &str) -> bsmr_error::Result<ConfiguredTargetNode>;
...
impl QueryEnvironment for ConfiguredGraphQueryEnvironment<'_> {
    ...
    async fn eval_literals(&self, literal: &[&str]) -> bsmr_error::Result<TargetSet<Self::Target>> {
...
async fn get_template_info_provider_artifacts(
    ...
    template_name: &str,
) -> bsmr_error::Result<Vec<ArtifactGroup>> {
    let providers_label =
