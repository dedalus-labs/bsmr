...
//! Server-side implementation of `bsmr targets` command
...
use bsmr_cli_proto::targets_request::TargetHashFileMode;
...
use bsmr_node::nodes::lookup::ConfiguredTargetNodeLookup;
    ...
    let target_hashes = dice
        ...
        .with_linear_recompute(|linear_ctx| async move {
            match hash_options.graph_type {
                TargetHashGraphType::Configured => bsmr_error::Ok(Some(
