...
//! Hash function abstractions for bsmr.
//!
//! This crate provides a level of indirection for hash function implementations
//! used throughout bsmr. The default hasher used by Rust's `HashMap` is
...
/// A hasher for bsmr internal use.
///
