...
fn parse_build_report_option(s: &str) -> bsmr_error::Result<BuildReportOption> {
...
impl CommonBuildOptions {
    ...
    pub fn to_proto(&self) -> bsmr_cli_proto::CommonBuildOptions {
        ...
        bsmr_cli_proto::CommonBuildOptions {
            concurrency,
