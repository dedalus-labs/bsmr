...
pub const SYSTEM_MEMORY_REMEDIATION_LINK: &str = ": https://fburl.com/bsmr_mem_remediation";
pub const DISK_REMEDIATION_LINK: &str = ": https://fburl.com/bsmr_disk_remediation";

pub(crate) fn system_memory_exceeded_msg(memory_pressure: &MemoryPressureHigh) -> String {
    format!(
        "High memory pressure: bsmr is using {} out of {}{}",
