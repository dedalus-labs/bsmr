...
use bsmr_event_observer::humanized::HumanizedCount;
use bsmr_event_observer::pending_estimate::pending_estimate;
use bsmr_event_observer::progress::BuildProgressPhaseStats;
use bsmr_event_observer::progress::BuildProgressStats;
...
impl Component for CountComponent<'_> {
    ...
    fn draw_unchecked(&self, _dimensions: Dimensions, mode: DrawMode) -> bsmr_error::Result<Lines> {
        match mode {
            DrawMode::Normal => {
...
mod tests {
    ...
    use bsmr_event_observer::progress::BuildProgressPhaseStatsItem;
    ...
    #[test]
    fn test_different_sizes_dont_fail() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_rendering_golden() -> bsmr_error::Result<()> {
        ...
        for width in [30, 40, 60, 80, 100, 129, 130, 140, 160] {
            ...
            .map_err(|e| from_any_with_tag(e, bsmr_error::ErrorTag::SuperConsole))?;
        }
    ...
    #[test]
    fn test_validation_line_not_shown_when_not_started() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_remaining_with_pending() -> bsmr_error::Result<()> {
        let action_stats = ActionStats {
            local_actions: 0,
            remote_actions: 0,
            cached_actions: 0,
    ...
    #[test]
    fn test_children() -> bsmr_error::Result<()> {
        let action_stats = ActionStats {
            local_actions: 0,
            remote_actions: 0,
            cached_actions: 1,
    ...
    #[test]
    fn test_simple_header_final() -> bsmr_error::Result<()> {
        let action_stats = ActionStats {
            local_actions: 0,
            remote_actions: 0,
            cached_actions: 1,
