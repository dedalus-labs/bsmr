...
impl Component for TimedListHeader {
    ...
    fn draw_unchecked(&self, dimensions: Dimensions, _mode: DrawMode) -> bsmr_error::Result<Lines> {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_remaining_with_pending() -> bsmr_error::Result<()> {
        let tick = Tick::now();
    ...
    fn test_children() -> bsmr_error::Result<()> {
        ...
        let prepare = Arc::new(BuckEvent::new(
            ...
            SpanStartEvent {
                data: Some(
                    bsmr_data::ExecutorStageStart {
                        stage: Some(bsmr_data::PrepareAction {}.into()),
                    }
                    .into(),
                ),
            }
