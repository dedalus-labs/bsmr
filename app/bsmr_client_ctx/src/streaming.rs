...
use bsmr_common::init::DEFAULT_RETAINED_EVENT_LOGS;
...
fn update_events_ctx<T: StreamingCommand>(
    ...
    let enable_health_checks = ctx
        ...
        || std::env::var_os("BSMR_TEST_SLOW_BUILD_CHECK").is_some();
...
/// Trait to generalize the behavior of executable bsmr commands that rely on a server.
