...
impl PerThreadInstructionCounter {
    ...
    pub fn init() -> bsmr_error::Result<Option<PerThreadInstructionCounter>> {
        Self::init_impl()
    }

    #[cfg(target_os = "linux")]
    fn init_impl() -> bsmr_error::Result<Option<PerThreadInstructionCounter>> {
    ...
    pub fn collect(self) -> bsmr_error::Result<u64> {
        self.collect_impl()
    }

    #[cfg(target_os = "linux")]
    fn collect_impl(mut self) -> bsmr_error::Result<u64> {
    ...
    #[cfg(not(target_os = "linux"))]
    fn collect_impl(self) -> bsmr_error::Result<u64> {
