...
impl<Kind: CasDigestKind> CasDigest<Kind> {
    ...
    pub fn from_reader<R: Read>(reader: R, config: CasDigestConfig) -> bsmr_error::Result<Self> {
...
impl<Kind: CasDigestKind> bsmr_core::directory_digest::DirectoryDigest for TrackedCasDigest<Kind> {}
