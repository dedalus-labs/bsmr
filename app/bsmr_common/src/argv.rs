...
mod tests {
    ...
    #[test]
    fn test_get_representative_config_flags() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_get_representative_config_flags_for_flagfiles() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_get_representative_config_flags_stops_at_double_dash() -> bsmr_error::Result<()> {
        let mut argv = ExpandedArgvBuilder::new();
        argv.push("-c".to_owned());
        argv.push("section.option=value".to_owned());
        argv.push("--config".to_owned());
