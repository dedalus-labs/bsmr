...
pub const BSMR_AUTH_TOKEN_HEADER: &str = "x-bsmr-auth-token";
...
impl ConnectionType {
    pub fn parse(endpoint: &str) -> bsmr_error::Result<ConnectionType> {
        ...
        match protocol {
            ...
            "tcp" => Ok(ConnectionType::Tcp {
                port: endpoint.parse().with_bsmr_error_context(|| {
...
mod tests {
    ...
    use crate::daemon_connection::ConnectionType;
