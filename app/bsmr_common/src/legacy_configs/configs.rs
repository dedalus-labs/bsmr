...
) -> bsmr_error::Result<ConfigSectionAndKey> {
...
pub(crate) mod tests {
    ...
    #[test]
    fn test_simple() -> bsmr_error::Result<()> {
        let config = parse(
            &[(
                "config",
                indoc!(
    ...
    #[test]
    fn test_comments() -> bsmr_error::Result<()> {
        let config = parse(
            &[(
                "config",
                indoc!(
    ...
    #[test]
    fn test_references() -> bsmr_error::Result<()> {
        let config = parse(
            &[(
                "config",
                indoc!(
    ...
    #[test]
    fn test_reference_cycle() -> bsmr_error::Result<()> {
        let res = parse(
            &[(
                "config",
                indoc!(
    ...
    #[test]
    fn test_includes() -> bsmr_error::Result<()> {
        let config = parse(
            &[
                (
                    "base",
    ...
    #[test]
    fn test_config_args_ordering() -> bsmr_error::Result<()> {
        let config_args = vec![
    ...
    #[test]
    fn test_config_args_empty() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_config_args_overwrite_config_file() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_section_and_key() -> bsmr_error::Result<()> {
        // Valid Formats
    ...
    #[test]
    fn test_config_file_args_overwrite_config_file() -> bsmr_error::Result<()> {
        let config_args = vec![
    ...
    #[test]
    fn test_config_args_cell_in_value() -> bsmr_error::Result<()> {
