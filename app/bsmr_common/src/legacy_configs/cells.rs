...
use bsmr_core::cells::external::GitObjectFormat;
...
impl ExternalBsmrconfigData {
    ...
    pub async fn get_bsmrconfig_components(
        ...
        let mut res: Vec<bsmr_data::BsmrconfigComponent> = self
            ...
            .into_iter()
            .map(|o| {
                let external_file = bsmr_data::GlobalExternalConfig {
...
impl BsmrConfigBasedCells {
    ...
    pub async fn parse_with_config_args(
        project_fs: &ProjectRoot,
        config_args: &[bsmr_cli_proto::ConfigOverride],
...
async fn get_external_bsmrconfig_paths(
    ...
    let skip_default_external_config = bsmr_env!(
        "BSMR_TEST_SKIP_DEFAULT_EXTERNAL_CONFIG",
        bool,
...
mod tests {
    ...
    #[tokio::test]
    async fn test_external_cell_configs() -> bsmr_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_nested_external_cell_configs() -> bsmr_error::Result<()> {
        initialize_external_cells_impl();
    ...
    #[tokio::test]
    async fn test_missing_bundled_cell() -> bsmr_error::Result<()> {
        initialize_external_cells_impl();
    ...
    #[tokio::test]
    async fn test_git_external_cell() -> bsmr_error::Result<()> {
        initialize_external_cells_impl();
    ...
    #[tokio::test]
    async fn test_git_external_cell_invalid_sha1() -> bsmr_error::Result<()> {
        initialize_external_cells_impl();
