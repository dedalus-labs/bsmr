...
impl ResolvedItems {
    fn start_resolving(&mut self, section: &str, key: &str) -> bsmr_error::Result<()> {
    ...
    fn drain_to(self, value: &mut BTreeMap<String, SectionBuilder>) -> bsmr_error::Result<()> {
...
impl ConfigResolver {
    ...
    fn resolve_all(&mut self) -> bsmr_error::Result<()> {
