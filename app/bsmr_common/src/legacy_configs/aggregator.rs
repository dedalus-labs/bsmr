...
impl CellsAggregator {
    ...
    pub(crate) fn make_cell_resolver(self) -> bsmr_error::Result<CellResolver> {
...
mod tests {
    ...
    #[test]
    fn test_duplicate_paths() -> bsmr_error::Result<()> {
