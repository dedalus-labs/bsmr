...
pub trait FileOps: Send + Sync {
    ...
    async fn read_dir(&self, path: CellPathRef<'async_trait>) -> bsmr_error::Result<ReadDirOutput>;
    ...
    async fn buildfiles<'a>(&self, cell: CellName) -> bsmr_error::Result<Arc<[FileNameBuf]>>;
}
