...
impl DiceFileComputations {
    ...
    pub async fn read_dir(
        ...
        path: CellPathRef<'_>,
    ) -> bsmr_error::Result<ReadDirOutput> {
    ...
    pub async fn is_ignored(
        ctx: &mut DiceComputations<'_>,
        path: CellPathRef<'_>,
    ) -> bsmr_error::Result<FileIgnoreResult> {
    ...
    pub async fn buildfiles(
        ctx: &mut DiceComputations<'_>,
        cell: CellName,
    ) -> bsmr_error::Result<Arc<[FileNameBuf]>> {
...
impl FileChangeTracker {
    ...
    pub fn write_to_dice(mut self, ctx: &mut DiceTransactionUpdater) -> bsmr_error::Result<()> {
...
impl Key for ReadFileKey {
    type Value = bsmr_error::Result<ReadFileValue>;
    async fn compute(
        &self,
...
impl Key for ReadDirKey {
    type Value = bsmr_error::Result<ReadDirOutput>;
    async fn compute(
        &self,
        ctx: &mut DiceComputations,
        _cancellations: &CancellationContext,
...
impl Key for ExistsMatchingExactCaseKey {
    type Value = bsmr_error::Result<bool>;
    async fn compute(
        &self,
        ctx: &mut DiceComputations,
        _cancellations: &CancellationContext,
...
impl Key for PathMetadataKey {
    type Value = bsmr_error::Result<Option<RawPathMetadata>>;
    async fn compute(
        &self,
        ctx: &mut DiceComputations,
        _cancellations: &CancellationContext,
