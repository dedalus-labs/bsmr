...
impl FileReadError {
    pub fn with_package_context_information(self, package_path: String) -> bsmr_error::Error {
        match self {
...
pub trait FileReadErrorContext<T> {
    fn with_package_context_information(self, package_path: String) -> bsmr_error::Result<T>;
    fn without_package_context_information(self) -> bsmr_error::Result<T>;
}
