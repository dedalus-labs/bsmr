...
pub(crate) struct CriticalPathProtoEnhancer {
    ...
    entries: Vec<bsmr_data::CriticalPathEntry2>,
}
...
impl CriticalPathProtoEnhancer {
    ...
    pub(crate) fn add_entry(&mut self, entry: DetailedCriticalPathEntry) {
            ...
            .is_zero()
        {
            self.add_simple_entry(
                None,
                bsmr_data::critical_path_entry2::Entry::Waiting(
                    bsmr_data::critical_path_entry2::Waiting {
    ...
    pub(crate) fn add_simple_entry(
        ...
        entry: bsmr_data::critical_path_entry2::Entry,
        time_span: TimeSpan,
        is_critical: bool,
    ) {
    ...
    pub(crate) fn into_entries(self) -> Vec<bsmr_data::CriticalPathEntry2> {
        self.entries
    }
