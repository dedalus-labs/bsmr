...
use bsmr_critical_path::AddEdgesError;
use bsmr_critical_path::Graph;
use bsmr_critical_path::GraphBuilder;
use bsmr_critical_path::OptionalVertexId;
use bsmr_critical_path::PushError;
use bsmr_critical_path::TopoSortError;
use bsmr_critical_path::VertexData;
use bsmr_critical_path::VertexId;
use bsmr_critical_path::VertexKeys;
use bsmr_critical_path::compute_critical_path_potentials;
    ...
    let critical_path_for_top_level_targets = top_level_targets
        ...
        .filter_map(|t| {
            let max_cost = (|| {
                ...
                bsmr_error::Result::Ok(Duration::from_micros(path_cost.runtime))
            })();
