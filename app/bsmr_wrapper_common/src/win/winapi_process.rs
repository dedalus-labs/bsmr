...
impl WinapiProcessHandle {
    ...
    pub(crate) fn terminate(&self) -> bsmr_error::Result<()> {
        unsafe {
    ...
    pub(crate) fn process_creation_time(&self) -> bsmr_error::Result<Duration> {
    ...
    fn exit_code(&self) -> bsmr_error::Result<Option<u32>> {
        let mut exit_code = 0;
    ...
    pub(crate) fn has_exited(&self) -> bsmr_error::Result<bool> {
