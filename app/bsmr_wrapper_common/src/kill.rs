...
pub fn process_exists(pid: Pid) -> bsmr_error::Result<bool> {
...
pub fn kill(pid: Pid) -> bsmr_error::Result<Option<KilledProcessHandle>> {
    match imp::kill(pid)? {
...
impl KilledProcessHandle {
    pub fn has_exited(&self) -> bsmr_error::Result<bool> {
