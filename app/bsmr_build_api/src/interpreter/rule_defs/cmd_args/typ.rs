        ...
        if !self.ignore_artifacts() {
            ...
            impl<'v> CommandLineArtifactVisitor<'v> for IgnoredArtifactsVisitor {
                ...
                fn visit_declared_artifact(
                    &mut self,
                    declared_artifact: bsmr_artifact::artifact::artifact_type::DeclaredArtifact,
...
impl<'v> StarlarkCmdArgs<'v> {
    ...
    pub fn try_from_value(value: Value<'v>) -> bsmr_error::Result<Self> {
...
impl<'v> StarlarkCommandLineData<'v> {
    fn add_value(&mut self, value: Value<'v>) -> bsmr_error::Result<()> {
    ...
    fn add_values(&mut self, values: &[Value<'v>]) -> bsmr_error::Result<()> {
    ...
    fn add_hidden(&mut self, value: StarlarkCommandLineValueUnpack<'v>) -> bsmr_error::Result<()> {
        match value {
