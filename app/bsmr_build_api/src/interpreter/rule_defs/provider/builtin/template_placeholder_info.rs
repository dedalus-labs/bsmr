...
fn verify_variables_type(field_key: &str, variables: Value) -> bsmr_error::Result<()> {
...
impl<'v> TemplatePlaceholderInfo<'v> {
    fn new(unkeyed_variables: Value<'v>, keyed_variables: Value<'v>) -> bsmr_error::Result<Self> {
