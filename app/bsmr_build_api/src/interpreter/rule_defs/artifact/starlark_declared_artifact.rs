...
impl<'v> StarlarkInputArtifactLike<'v> for StarlarkDeclaredArtifact<'v> {
    ...
    fn as_output(&'v self, this: Value<'v>) -> bsmr_error::Result<StarlarkOutputArtifact<'v>> {
...
impl<'v> CommandLineArgLike<'v> for StarlarkDeclaredArtifact<'v> {
    ...
    fn add_to_command_line(&self, _fmt: &mut CommandLineBuilder<'v, '_>) -> bsmr_error::Result<()> {
