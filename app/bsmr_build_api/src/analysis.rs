...
// TODO(@wendyy) move into `bsmr_node`
pub mod anon_promises_dyn;
// TODO(@wendyy) move into `bsmr_interpreter_for_build`
...
impl AnalysisResult {
    ...
    pub fn providers(&self) -> bsmr_error::Result<FrozenProviderCollectionValueRef<'_>> {
