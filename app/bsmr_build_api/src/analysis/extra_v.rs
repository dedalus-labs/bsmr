...
impl<'v> AnalysisExtraValue<'v> {
    pub fn get(module: &Module<'v>) -> bsmr_error::Result<Option<&'v AnalysisExtraValue<'v>>> {
    ...
    pub fn get_or_init(module: &Module<'v>) -> bsmr_error::Result<&'v AnalysisExtraValue<'v>> {
...
impl FrozenAnalysisExtraValue {
    pub fn get(
        module: &FrozenModule,
    ) -> bsmr_error::Result<OwnedFrozenValueTyped<StarlarkAnyComplex<FrozenAnalysisExtraValue>>>
    {
        Ok(module
            .owned_extra_value()
