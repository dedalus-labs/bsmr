...
///
/// In paranoid mode, Bessemer makes minimal assumptions about the reliability of the RE Backend it
/// interacts with. In particular, Bessemer will always race local and remote execution (including
    ...
    pub fn exec(self, _matches: BuckArgMatches<'_>, ctx: ClientCommandContext<'_>) -> ExitResult {
        ...
        match self {
            Self::Enable(enable) => {
                ...
                let data = bsmr_cli_proto::ParanoidInfo {
