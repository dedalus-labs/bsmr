...
impl CellPathWithAllowedRelativeDir {
    ...
    pub fn join_normalized(&self, path: &RelativePath) -> bsmr_error::Result<CellPath> {
...
mod tests {
    ...
    #[test]
    fn parent_directory_traversal() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn multiple_parent_directory_traversal() -> bsmr_error::Result<()> {
        let import = "../../foo.bzl";
        let cell_path_with_allowed_relative_dir = CellPathWithAllowedRelativeDir {
    ...
    #[test]
    fn parent_directory_with_subpath() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn traversal_out_of_allowed_dir() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn nonleading_parent_dir_component() -> bsmr_error::Result<()> {
