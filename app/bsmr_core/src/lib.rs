...
pub use bsmr_env::env;
pub use bsmr_env::soft_error as error;
...
// Re-export macros from bsmr_env so they're available at the crate root
pub use bsmr_env::env::bsmr_env;
pub use bsmr_env::env::bsmr_env_name;
...
#[doc(inline)]
pub use bsmr_env::soft_error::tag_error;
#[doc(inline)]
pub use bsmr_env::soft_error::tag_result;
