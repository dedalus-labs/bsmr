...
//! Conversion impls for different error types to 'bsmr_error::Error'
...
/// Helper function that can be explicitly called to convert `std::error::Error` into `bsmr_error`.
///
