...
pub(crate) async fn get_mergebase<D: AsRef<Path>, C: AsRef<str>, M: AsRef<str>>(
    ...
    commit: C,
    mergegase_with: M,
) -> bsmr_error::Result<Option<MergebaseDetails>> {
...
pub(crate) async fn get_status<D: AsRef<Path>, F: AsRef<str>, S: AsRef<str>>(
    ...
    second: Option<S>,
    limit_results: usize,
) -> bsmr_error::Result<SaplingGetStatusResult> {
...
fn process_one_status_line(line: &str) -> bsmr_error::Result<Option<(SaplingStatus, String)>> {
...
mod tests {
    ...
    #[test]
    fn test_hg_status_line() -> bsmr_error::Result<()> {
        assert_eq!(
            process_one_status_line("M bsmr/app/bsmr_file_watcher/src/edenfs/sapling.rs")?,
            Some((
                SaplingStatus::Modified,
                "bsmr/app/bsmr_file_watcher/src/edenfs/sapling.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("A bsmr/app/bsmr_file_watcher/src/edenfs/interface.rs")?,
            Some((
                SaplingStatus::Added,
                "bsmr/app/bsmr_file_watcher/src/edenfs/interface.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("R bsmr/app/bsmr_file_watcher/src/edenfs/utils.rs")?,
            Some((
                SaplingStatus::Removed,
                "bsmr/app/bsmr_file_watcher/src/edenfs/utils.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("! bsmr/app/bsmr_file_watcher/src/edenfs/sapling.rs")?,
            Some((
        ...
        assert_eq!(
            process_one_status_line("C bsmr/app/bsmr_file_watcher/src/edenfs/sapling.rs")?,
            Some((
                SaplingStatus::Clean,
                "bsmr/app/bsmr_file_watcher/src/edenfs/sapling.rs".to_owned()
            ))
        ...
        assert_eq!(
            process_one_status_line("I bsmr/app/bsmr_file_watcher/src/edenfs/sapling.rs")?,
            Some((
        ...
        assert!(
            process_one_status_line("Mbsmr/app/bsmr_file_watcher/src/edenfs/sapling.rs").is_err()
        );

        // Malformed status (colon instead of space)
        assert!(
            process_one_status_line("M:bsmr/app/bsmr_file_watcher/src/edenfs/sapling.rs").is_err()
        );
    ...
    #[test]
    fn test_parse_log_output() -> bsmr_error::Result<()> {
        // the format is {node}\n{date}\n{global_rev}
        let output =
    ...
    #[test]
    fn test_parse_log_output_no_global_rev() -> bsmr_error::Result<()> {
