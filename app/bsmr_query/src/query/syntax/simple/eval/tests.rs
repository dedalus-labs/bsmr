...
impl QueryEnvironment for Env {
    ...
    async fn get_node(&self, _node_ref: &TargetRef) -> bsmr_error::Result<Self::Target> {
        unimplemented!()
    }
    ...
    async fn dfs_postorder(
        ...
        _visit: impl FnMut(Self::Target) -> bsmr_error::Result<()> + Send,
    ) -> bsmr_error::Result<()> {
        unimplemented!()
    }
...
#[tokio::test]
pub async fn test_missing_arg() -> bsmr_error::Result<()> {
