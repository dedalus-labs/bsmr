...
use bsmr_build_api::interpreter::rule_defs::provider::builtin::configuration_info::FrozenConfigurationInfo;
use bsmr_build_api::interpreter::rule_defs::provider::builtin::platform_info::FrozenPlatformInfo;
...
use bsmr_node::configuration::calculation::ConfigurationCalculationDyn;
use bsmr_node::configuration::resolved::ConfigurationNode;
...
impl Key for MatchedConfigurationSettingKeysKey {
    type Value = bsmr_error::Result<MatchedConfigurationSettingKeysWithCfg>;
...
async fn get_configuration_node(
    ...
    target_cell: CellNameForConfigurationResolution,
    cfg_target: &ConfigurationSettingKey,
) -> bsmr_error::Result<ConfigurationNode> {
...
impl Key for ConfigurationNodeKey {
    type Value = bsmr_error::Result<ConfigurationNode>;
...
) -> bsmr_error::Result<OrderedMap<TargetLabel, ConfigurationData>> {
...
) -> bsmr_error::Result<MatchedConfigurationSettingKeysWithCfg> {
