...
use bsmr_node::target_calculation::CONFIGURED_TARGET_CALCULATION;
use bsmr_node::target_calculation::ConfiguredTargetCalculationImpl;
...
async fn get_target_platform_detector(
    ...
    impl Key for TargetPlatformDetectorKey {
        type Value = bsmr_error::Result<Arc<TargetPlatformDetector>>;
        async fn compute(
            &self,
...
impl ConfiguredTargetCalculationImpl for ConfiguredTargetCalculationInstance {
    ...
    ) -> bsmr_error::Result<ConfiguredTargetLabel> {
