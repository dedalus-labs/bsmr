...
pub enum SpawnError {
    ...
    GenericError(bsmr_error::Error),
}

impl From<bsmr_error::Error> for SpawnError {
    #[cold]
...
impl ProcessGroup {
    ...
    ) -> bsmr_error::Result<(ExitStatus, Vec<bsmr_resource_control::OrphanProcessInfo>)> {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_process_impl() -> bsmr_error::Result<()> {
        let mut cmd;
