...
pub use bsmr_data::NetworkAccess;
...
impl ExecutorPreference {
    pub fn and(self, other: Self) -> bsmr_error::Result<Self> {
...
impl CommandExecutionPaths {
    pub fn new(
        ...
        let input_files_bytes = if bsmr_core::faster_directories::is_enabled() {
...
pub struct CommandExecutionRequest {
    ...
    /// What environment variables to inherit from the Bessemer daemon.
...
impl CommandExecutionOutputRef<'_> {
    ...
    ) -> bsmr_error::Result<ResolvedCommandExecutionOutput> {
        match self {
