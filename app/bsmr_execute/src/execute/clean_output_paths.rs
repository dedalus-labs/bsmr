...
#[cfg(unix)]
fn tag_environment_error(error: bsmr_error::Error) -> bsmr_error::Error {
    error
}
...
pub fn cleanup_path(fs: &ProjectRoot, path: &ProjectRelativePath) -> bsmr_error::Result<()> {
        ...
        path = match path.parent() {
            ...
            None => {
                return Err(bsmr_error!(
                    bsmr_error::ErrorTag::CleanOutputs,
