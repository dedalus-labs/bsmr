...
impl CommandExecutionManagerLike for CommandExecutionManager {
    fn result(
        ...
        CommandExecutionResult {
            ...
            cache_upload_result: bsmr_data::UploadResult::DidNotUploadUnspecified,
            dep_file_cache_upload_result: bsmr_data::UploadResult::DidNotUploadUnspecified,
            dep_file_key: None,
...
pub trait CommandExecutionManagerExt: Sized {
    ...
    fn error(
        self,
        stage: &'static str,
        error: impl Into<bsmr_error::Error>,
    ) -> CommandExecutionResult {
...
fn inline_environment_metadata() -> bsmr_data::InlineCommandExecutionEnvironmentMetadata {
    bsmr_data::InlineCommandExecutionEnvironmentMetadata {
        sandcastle_instance_id:
            bsmr_env!("SANDCASTLE_INSTANCE_ID", type = u64, applicability = internal)
                .ok()
                .flatten(),
    }
}
