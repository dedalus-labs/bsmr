...
use bsmr_core::execution_types::executor_config::OutputPathsBehavior;
...
impl CommandExecutor {
    ...
    pub fn prepare_action(
        ...
        executor_stage(bsmr_data::PrepareAction {}, || {
                ...
                && let Some(key) = worker.remote_key.as_ref()
            {
                ...
                // TODO[AH] Ideally, Bessemer could generate an argfile on the fly.
