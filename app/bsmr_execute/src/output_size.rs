...
mod tests {
    ...
    #[test]
    fn test_directory_with_multiple_files() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_nested_directory() -> bsmr_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
        let mut builder = ActionDirectoryBuilder::empty();
    ...
    #[test]
    fn test_symlinks_not_counted() -> bsmr_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
        let mut builder = ActionDirectoryBuilder::empty();
    ...
    #[test]
    fn test_symlinks_counted_when_included() -> bsmr_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
        let mut builder = ActionDirectoryBuilder::empty();
    ...
    #[test]
    fn test_file_size_matches_physical_disk_size() -> bsmr_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_directory_size_matches_physical_disk_size() -> bsmr_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[cfg(unix)]
    #[test]
    fn test_symlink_size_matches_physical_disk_size() -> bsmr_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
        let tempdir = tempfile::tempdir()?;
