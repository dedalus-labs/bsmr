...
use bsmr_util::arc_str::ThinArcS;
...
impl<'v> DeclaredArtifact<'v> {
    ...
    pub fn ensure_bound(self) -> bsmr_error::Result<BoundBuildArtifact> {
        let borrow = self.artifact().borrow();
...
impl<'v> OutputArtifact<'v> {
    pub fn bind(&self, key: ActionKey) -> bsmr_error::Result<BoundBuildArtifact> {
    ...
    pub fn ensure_output_type(&self, output_type: OutputType) -> bsmr_error::Result<()> {
...
impl UnboundArtifact {
    fn bind(self, key: ActionKey) -> bsmr_error::Result<BuildArtifact> {
...
mod tests {
    ...
    #[test]
    fn artifact_binding() -> bsmr_error::Result<()> {
        Heap::temp(|heap| {
    ...
    #[test]
    fn resolve_artifact() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn writes_files() -> bsmr_error::Result<()> {
