...
impl StringWithMacros<ConfiguredProvidersLabel> {
    pub fn concat(
        self,
        items: impl Iterator<Item = bsmr_error::Result<Self>>,
...
impl StringWithMacros<ProvidersLabel> {
    ...
    ) -> bsmr_error::Result<ConfiguredStringWithMacros> {
        match self {
...
impl MacroBase<ProvidersLabel> {
    pub fn configure(
        &self,
        ctx: &dyn AttrConfigurationContext,
    ) -> bsmr_error::Result<ConfiguredMacro> {
        Ok(match self {
...
impl StringWithMacrosPart<ProvidersLabel> {
    pub(crate) fn configure(
        &self,
        ctx: &dyn AttrConfigurationContext,
    ) -> bsmr_error::Result<ConfiguredStringWithMacrosPart> {
        match self {
