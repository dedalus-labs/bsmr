...
impl CoercedSelector {
    ...
    ) -> bsmr_error::Result<CoercedSelector> {
    ...
    fn check_all_keys_unique(
        ...
        fn duplicate_key(key: &ConfigurationSettingKey) -> bsmr_error::Error {
            bsmr_error!(
    ...
    pub fn to_json(&self, ctx: &AttrFmtContext) -> bsmr_error::Result<serde_json::Value> {
    ...
    fn fail_to_json(message: &ArcStr) -> Result<serde_json::Value, bsmr_error::Error> {
        Ok(serde_json::Value::Object(serde_json::Map::from_iter([
            (
                "__type".to_owned(),
    ...
    fn incompatible_to_json(message: &ArcStr) -> Result<serde_json::Value, bsmr_error::Error> {
        Ok(serde_json::Value::Object(serde_json::Map::from_iter([
            (
                "__type".to_owned(),
...
impl CoercedAttr {
    ...
    pub fn select_the_most_specific<'a, 'x>(
        ...
        >,
    ) -> bsmr_error::Result<Option<&'a CoercedAttr>> {
    ...
    ) -> bsmr_error::Result<&'a CoercedAttr> {
