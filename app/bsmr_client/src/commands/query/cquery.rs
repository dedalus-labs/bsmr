...
"#,
        if_else_opensource!(
            ...
            "https://www.internalfb.com/intern/staticdocs/bsmr/docs/users/query/cquery/",
        ),
        r#"
...
#[clap(
    ...
    long_about = help(),
    after_help = "Run `bsmr docs cquery` for detailed information about query functions such as allbuildfiles, allpaths, attrfilter, and more.",
    after_long_help = "",
            ...
            .cquery(
                CqueryRequest {
                    ...
                    profile_output: self
                        ...
                        .profile_output
                        .as_ref()
                        .map(|p| bsmr_error::Ok(p.resolve(&ctx.working_dir).to_str()?.to_owned()))
                        .transpose()?,
                },
                events_ctx,
