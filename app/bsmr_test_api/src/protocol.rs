...
pub trait TestExecutor: Send + Sync {
    ...
    async fn unstable_heap_dump(&self, _: &str) -> bsmr_error::Result<()> {
        Err(bsmr_error::bsmr_error!(ErrorTag::Input, "Unimplemented!"))
    }
}
...
pub trait TestOrchestrator: Send + Sync {
    ...
    /// Everstore. Bessemer handles the actual CAS upload using its RE client.
