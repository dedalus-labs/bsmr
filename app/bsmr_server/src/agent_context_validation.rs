...
//! description = The purpose of this bsmr invocation
//! ```
...
pub(crate) fn validate_agent_context(
    ...
    entries: &[bsmr_data::AgentContextEntry],
) -> bsmr_error::Result<()> {
    ...
    for entry in entries {
        ...
        // Skip keys injected from BSMR_CLIENT_METADATA env var —
...
mod tests {
    ...
    fn entry(key: &str, value: &str) -> bsmr_data::AgentContextEntry {
