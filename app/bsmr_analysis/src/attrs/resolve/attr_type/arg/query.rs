...
use bsmr_build_api::interpreter::rule_defs::resolve_query_macro::ResolvedQueryMacro;
use bsmr_build_api::interpreter::rule_defs::resolve_query_macro::ResolvedQueryMacroTargetAndOutputs;
...
pub(crate) trait ConfiguredQueryMacroBaseExt {
    ...
    ) -> bsmr_error::Result<ResolvedQueryMacro>;
}
