...
use bsmr_build_api::interpreter::rule_defs::provider::builtin::run_info::RunInfoCallable;
use bsmr_build_api::interpreter::rule_defs::provider::builtin::template_placeholder_info::FrozenTemplatePlaceholderInfo;
use bsmr_build_api::interpreter::rule_defs::resolved_macro::ResolvedMacro;
use bsmr_build_api::interpreter::rule_defs::resolved_macro::ResolvedStringWithMacros;
use bsmr_build_api::interpreter::rule_defs::resolved_macro::ResolvedStringWithMacrosPart;
...
fn resolve_configured_macro<'v>(
    ...
    ctx: &mut dyn AttrResolutionContext<'v>,
    pkg: PackageLabel,
) -> bsmr_error::Result<ResolvedMacro<'v>> {
