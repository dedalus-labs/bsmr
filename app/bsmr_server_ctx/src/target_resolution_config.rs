...
use bsmr_core::pattern::pattern_type::ConfiguredTargetPatternExtra;
...
use bsmr_node::configured_universe::UNIVERSE_FROM_LITERALS;
...
impl TargetResolutionConfig {
    ...
    ) -> bsmr_error::Result<Vec<ConfiguredTargetLabel>> {
        match self {
    ...
    ) -> bsmr_error::Result<Vec<ConfiguredProvidersLabel>> {
        Ok(self
