...
impl ServerCommandTemplate for AqueryServerCommand {
    type StartEvent = bsmr_data::AqueryCommandStart;
    type EndEvent = bsmr_data::AqueryCommandEnd;
    type Response = bsmr_cli_proto::AqueryResponse;
...
async fn aquery(
    ...
    request: &bsmr_cli_proto::AqueryRequest,
) -> bsmr_error::Result<bsmr_cli_proto::AqueryResponse> {
    ...
    let bsmr_cli_proto::AqueryRequest {
        query, query_args, ..
    } = request;
    ...
    Ok(bsmr_cli_proto::AqueryResponse {})
}
