...
struct JsonDoc {
    id: JsonIdentifier,
    item: JsonDocItem,
    custom_attrs: StdBsmrHashMap<String, String>,
}
...
impl JsonDoc {
    fn from_starlark(doc: Doc) -> Self {
        Self {
            ...
            custom_attrs: StdBsmrHashMap::default(),
        }
    }
}
...
// historical accident.
pub(crate) fn to_json(docs: Vec<(StarlarkFilePath, DocModule)>) -> bsmr_error::Result<String> {
    let docs: Vec<_> = docs
        .into_iter()
