...
use bsmr_interpreter_for_build::interpreter::globals::register_analysis_natives;
use bsmr_interpreter_for_build::interpreter::globals::register_bxl_natives;
use bsmr_interpreter_for_build::interpreter::globals::register_load_natives;
use bsmr_interpreter_for_build::interpreter::globals::starlark_library_extensions_for_bsmr;
...
) -> bsmr_error::Result<DocsResponse> {
    let starlark = Globals::extended_by(starlark_library_extensions_for_bsmr()).documentation();
