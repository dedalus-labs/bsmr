...
impl ExternalSymlink {
    ...
    pub fn interior_links(&self) -> bsmr_error::Result<Vec<AbsoluteSymlink>> {
...
///   `bsmr debug io-trace export-manifest`
...
impl RepositoryMetadata {
    ...
    pub fn from_path<P: AsRef<Path>>(path: P) -> bsmr_error::Result<Self> {
...
pub fn hg<I, S>(args: I) -> bsmr_error::Result<String>
where
...
fn hg_in<I, S, P>(path: P, args: I) -> bsmr_error::Result<String>
where
    I: IntoIterator<Item = S>,
    S: AsRef<OsStr>,
    P: AsRef<Path>,
...
mod tests {
    ...
    fn create_tree(entries: Vec<Entry>) -> bsmr_error::Result<TempDir> {
    ...
    #[test]
    fn test_full_target_no_remaining() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_full_target_with_remaining() -> bsmr_error::Result<()> {
        let external_link = ExternalSymlink {
            link: ProjectRelativePathBuf::unchecked_new("foo/bar/baz".to_owned()),
            target: AbsPathBuf::new("/some/absolute/path")?,
    ...
    #[test]
    fn test_interior_links_no_remaining() -> bsmr_error::Result<()> {
        let external_link = ExternalSymlink {
            link: ProjectRelativePathBuf::unchecked_new("foo/bar/baz".to_owned()),
            target: AbsPathBuf::new("/some/absolute/path")?,
            remaining_path: None,
    ...
    #[test]
    fn test_interior_links_relative() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_interior_links_absolute() -> bsmr_error::Result<()> {
        let tree = create_tree(vec![
            Entry::Dir("foo/bar/baz"),
            Entry::File("foo/bar/stuff.txt"),
            Entry::AbsoluteSymlink(Symlink {
