...
//! entirely within the Bessemer process, using the `TestOrchestrator` trait
...
use bsmr_test_api::data::LocalResourceType;
...
mod tests {
    ...
    use bsmr_test_api::data::ConfiguredTarget;
    use bsmr_test_api::data::ExecutionStream;
    use bsmr_test_api::data::ExternalRunnerSpec;
    use bsmr_test_api::data::ExternalRunnerSpecValue;
    use bsmr_test_api::data::testing::ConfiguredTargetHandleExt;
