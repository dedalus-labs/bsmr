...
pub(crate) enum EventLogErrors {
    ...
    #[bsmr(tag = EventLogIndexOutOfBounds)]
...
impl Invocation {
    ...
    pub fn to_proto(self) -> bsmr_data::Invocation {
        bsmr_data::Invocation {
    ...
    pub(crate) fn from_proto(proto: bsmr_data::Invocation) -> Self {
        Invocation {
...
pub mod timestamp {
    ...
    pub fn parse(time: &str) -> bsmr_error::Result<DateTime<Utc>> {
...
mod tests {
    ...
    fn test_parse_json_line() {
        ...
        let line = r#"{"command_line_args":["/some/path/bsmr","test","@//mode/mac","app/..."],"working_dir":"/Users/nga/dir45","trace_id":"281d1c16-8930-40cd-8fc1-7d71355c20f5"}"#;
        let line = Invocation::parse_json_line(line).unwrap();
        let expected = Invocation {
            command_line_args: vec![
                "/some/path/bsmr".to_owned(),
                "test".to_owned(),
                "@//mode/mac".to_owned(),
                "app/...".to_owned(),
            ],
