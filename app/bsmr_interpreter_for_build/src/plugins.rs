...
use bsmr_interpreter::plugins::PLUGIN_KIND_FROM_VALUE;
...
impl StarlarkPluginKind {
    pub fn expect_bound(&self) -> bsmr_error::Result<PluginKind> {
        match &*self.0.borrow() {
...
fn plugin_kind_from_value<'v>(v: Value<'v>) -> bsmr_error::Result<PluginKind> {
