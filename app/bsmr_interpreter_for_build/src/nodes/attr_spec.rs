...
use bsmr_node::attrs::spec::internal::NAME_ATTRIBUTE;
use bsmr_node::attrs::spec::internal::VISIBILITY_ATTRIBUTE;
use bsmr_node::attrs::spec::internal::WITHIN_VIEW_ATTRIBUTE;
use bsmr_node::attrs::spec::internal::attr_is_configurable;
use bsmr_node::attrs::values::AttrValues;
...
pub trait AttributeSpecExt {
    ...
    ) -> bsmr_error::Result<(&'v TargetNameRef, AttrValues)>;
