...
use bsmr_interpreter::late_binding_ty::AnalysisContextReprLate;
use bsmr_interpreter::late_binding_ty::ProviderReprLate;
use bsmr_interpreter::late_binding_ty::TransitionReprLate;
...
use bsmr_node::attrs::spec::AttributeSpec;
use bsmr_node::bzl_or_bxl_path::BzlOrBxlPath;
use bsmr_node::nodes::unconfigured::RuleKind;
use bsmr_node::nodes::unconfigured::TargetNode;
use bsmr_node::rule::Rule;
...
impl<'v> StarlarkRuleCallable<'v> {
    fn new(
    ...
    ) -> bsmr_error::Result<StarlarkRuleCallable<'v>> {
        ...
        let sorted_validated_attrs = attrs
            ...
            .collect::<bsmr_error::Result<Vec<(String, Attribute)>>>()?;
...
impl<'v> StarlarkValue<'v> for StarlarkRuleCallable<'v> {
    ...
    fn invoke(
        ...
        Err(bsmr_error::Error::from(RuleError::RuleCalledBeforeFreezing).into())
    }
...
fn unpack_frozen_rule(
    rule: FrozenValue,
) -> bsmr_error::Result<FrozenValueTyped<'static, FrozenStarlarkRuleCallable>> {
