...
use bsmr_node::attrs::coerced_path::CoercedDirectory;
use bsmr_node::attrs::coerced_path::CoercedPath;
...
impl BuildAttrCoercionContext {
    ...
    pub fn parse_pattern<P: PatternType>(
        &self,
        value: &str,
    ) -> bsmr_error::Result<ParsedPattern<P>> {
    ...
    fn coerce_label_no_cache(&self, value: &str) -> bsmr_error::Result<ProvidersLabel> {
    ...
    fn require_enclosing_package(
        &self,
        msg: &str,
    ) -> bsmr_error::Result<&(PackageLabel, PackageListing)> {
