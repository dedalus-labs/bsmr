...
pub static MAKE_CFG_CONSTRUCTOR: LateBinding<
    fn(OwnedFrozenValue) -> bsmr_error::Result<Arc<dyn CfgConstructorImpl>>,
...
impl<'v> PackageFileExtra<'v> {
    ...
    ) -> bsmr_error::Result<&'v PackageFileExtra<'v>> {
...
impl FrozenPackageFileExtra {
    pub(crate) fn get(
        module: &FrozenModule,
    ) -> bsmr_error::Result<Option<OwnedFrozenPackageFileExtra>> {
