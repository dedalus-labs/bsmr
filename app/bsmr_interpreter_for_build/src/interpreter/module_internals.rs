...
use bsmr_node::nodes::targets_map::TargetsMapRecordError;
use bsmr_node::nodes::unconfigured::TargetNode;
use bsmr_node::oncall::Oncall;
use bsmr_node::package::Package;
...
impl ModuleInternals {
    ...
    pub fn record(&self, target_node: TargetNode) -> bsmr_error::Result<()> {
    ...
    pub(crate) fn set_oncall(&self, name: &str) -> bsmr_error::Result<()> {
