...
impl<'v> StarlarkSelector<'v> {
    ...
    pub fn from_concat<I>(iter: I, heap: Heap<'v>) -> bsmr_error::Result<Value<'v>>
    where
        I: IntoIterator<Item = Value<'v>>,
    {
        fn values_to_selector<'v, I>(
            ...
            values: &mut I,
            heap: Heap<'v>,
        ) -> bsmr_error::Result<NoneOr<StarlarkSelector<'v>>>
        where
    ...
    fn select_map<'a, const RECURSE: bool>(
        ...
        bsmr_util::threads::check_stack_overflow()?;
...
/// The `Select` type represents a conditional attribute value in Bessemer.
///
...
///
/// When Bessemer resolves a `Select`:
///
...
/// # Platform Selection
///
/// Bessemer determines the target platform through:
///
...
/// Example:
/// ```bash
/// bsmr build //app:main --target-platforms //platforms:linux-x86_64
/// ```
///
/// # Target Compatibility
///
/// Bessemer provides two attributes for platform compatibility:
///
...
/// - Bessemer docs: "Configurations By Example"
#[starlark_module]
