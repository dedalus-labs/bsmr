...
fn run_ctx_test(
    content: &str,
    result_handler: impl FnOnce(starlark::Result<Value>) -> bsmr_error::Result<()>,
) -> bsmr_error::Result<()> {
...
#[test]
fn ctx_instantiates() -> bsmr_error::Result<()> {
    let content = indoc!(
        r#"
         def test(ctx):
...
#[test]
fn declare_output_declares_outputs() -> bsmr_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_with_prefix() -> bsmr_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_dot() -> bsmr_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_dot_bad() -> bsmr_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_dotdot() -> bsmr_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_require_bound() -> bsmr_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
