...
fn main() -> io::Result<()> {
    ...
    let includes = if let Ok(path) = &buck_proto_srcs {
        ...
        vec![
            ".",
            "../bsmr_data",
            "../bsmr_subscription_proto",
            "../bsmr_host_sharing_proto",
        ]
    };
    ...
    unsafe { builder.setup_protoc() }
        ...
        .field_attribute("timeout", "#[serde(rename = \"timeout_us\", with = \"bsmr_data::serialize_duration_as_micros\")]")
        .field_attribute("uptime", "#[serde(rename = \"uptime_us\", with = \"bsmr_data::serialize_duration_as_micros\")]")
        .field_attribute("delay", "#[serde(rename = \"delay_us\", with = \"bsmr_data::serialize_duration_as_micros\")]")
        .field_attribute("ProfileResponse.elapsed", "#[serde(rename = \"elapsed_us\", with = \"bsmr_data::serialize_duration_as_micros\")]")
