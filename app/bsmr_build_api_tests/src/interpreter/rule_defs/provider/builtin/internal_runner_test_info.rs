...
use bsmr_build_api::interpreter::rule_defs::required_test_local_resource::register_required_test_local_resource;
...
fn freeze_provider(
    starlark_code: &str,
) -> bsmr_error::Result<OwnedFrozenValueTyped<FrozenInternalRunnerTestInfo>> {
...
mod tests {
    ...
    #[test]
    fn test_minimal_construction() -> bsmr_error::Result<()> {
        let mut tester = tester();
    ...
    #[test]
    fn test_construction_with_optional_fields() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def test():
    ...
    #[test]
    fn test_construction_with_cmd_args() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def test():
    ...
    #[test]
    fn test_construction_with_local_resources() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def test():
    ...
    #[test]
    fn test_missing_type() -> bsmr_error::Result<()> {
        let mut tester = tester();
    ...
    #[test]
    fn test_missing_parse_test_listing() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_missing_parse_test_result() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_missing_listing_command() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_listing_command_empty_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_listing_command_with_cmd_args() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def test():
    ...
    #[test]
    fn test_type_must_be_string() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_parse_test_listing_must_be_callable() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_parse_test_result_must_be_callable() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_command_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_env_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_labels_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_contacts_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_bool_field_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_executor_overrides_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_default_executor_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_required_local_resources_validation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test_expecting_error(
            indoc!(
                r#"
    ...
    #[test]
    fn test_validation_at_freeze_contacts_mutation() -> bsmr_error::Result<()> {
        let mut tester = tester();
    ...
    #[test]
    fn test_validation_at_freeze_labels_mutation() -> bsmr_error::Result<()> {
        let mut tester = tester();
        let res = tester.add_import(
    ...
    #[test]
    fn test_parse_test_listing_callback_returns_list() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
    ...
    #[test]
    fn test_parse_test_listing_with_name_and_filter() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def my_listing_parser(stdout):
    ...
    #[test]
    fn test_parse_test_result_callback_returns_list() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def my_result_parser(stdout, stderr, exit_code):
    ...
    #[test]
    fn test_parse_test_result_with_all_fields() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def my_result_parser(stdout, stderr, exit_code):
    ...
    #[test]
    fn test_parse_test_result_with_integer_duration() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def my_result_parser(stdout, stderr, exit_code):
    ...
    #[test]
    fn test_json_based_listing_and_result_parsers() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
    ...
    #[test]
    fn test_line_based_listing_parser() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
    ...
    #[test]
    fn test_isinstance_checks() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def test():
    ...
    #[test]
    fn test_parse_test_result_various_statuses() -> bsmr_error::Result<()> {
        let mut tester = tester();
        tester.run_starlark_bzl_test(indoc!(
            r#"
        def my_result_parser(stdout, stderr, exit_code):
    ...
    #[test]
    fn test_parse_test_listing_output_basic() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_parse_test_listing_output_empty() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
        exported_info = InternalRunnerTestInfo(
            type = "custom",
    ...
    #[test]
    fn test_parse_test_listing_output_name_differs_from_filter() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
        def my_listing(stdout):
            return [
    ...
    #[test]
    fn test_parse_test_listing_output_missing_key() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
        exported_info = InternalRunnerTestInfo(
            type = "custom",
    ...
    #[test]
    fn test_parse_test_result_output_basic() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
    ...
    #[test]
    fn test_parse_test_result_output_all_fields() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
        def my_result(stdout, stderr, exit_code):
            return [{
    ...
    #[test]
    fn test_parse_test_result_output_integer_duration() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
        def my_result(stdout, stderr, exit_code):
    ...
    #[test]
    fn test_parse_test_result_output_negative_duration() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
        def my_result(stdout, stderr, exit_code):
    ...
    #[test]
    fn test_parse_test_result_output_invalid_status() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
        def my_result(stdout, stderr, exit_code):
    ...
    #[test]
    fn test_parse_test_result_output_missing_name() -> bsmr_error::Result<()> {
        let info = freeze_provider(indoc!(
            r#"
        def my_result(stdout, stderr, exit_code):
            return [{"status": "PASS"}]
...
#[test]
fn test_listing_command_accessor() -> bsmr_error::Result<()> {
