...
#[test]
fn test_format() -> bsmr_error::Result<()> {
...
#[test]
fn test_joined_with_empty_args() -> bsmr_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_quote_style_shell() -> bsmr_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_prepend() -> bsmr_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_list_list() -> bsmr_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex() -> bsmr_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex_old() -> bsmr_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex_regex() -> bsmr_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
