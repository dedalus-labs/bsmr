...
#[test]
fn test_relative_absolute_old() -> bsmr_error::Result<()> {
...
#[test]
fn test_relative_to_does_not_affect_new_artifacts() -> bsmr_error::Result<()> {
...
#[test]
fn test_parent_error_negative() -> bsmr_error::Result<()> {
    let mut tester = tester()?;
    let bad_count = indoc!(
        r#"
        def test():
