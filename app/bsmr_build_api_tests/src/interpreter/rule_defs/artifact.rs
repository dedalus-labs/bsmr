...
#[test]
fn source_artifact() -> bsmr_error::Result<()> {
...
#[test]
fn bound_artifact() -> bsmr_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(bsmr_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn declared_artifact() -> bsmr_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn output_artifact() -> bsmr_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn declared_bound() -> bsmr_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(bsmr_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
...
#[test]
fn project_declared_artifact() -> bsmr_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn test_short_path() -> bsmr_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn stringifies_for_command_line() -> bsmr_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn bound_artifact_with_associated_artifacts() -> bsmr_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(bsmr_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
