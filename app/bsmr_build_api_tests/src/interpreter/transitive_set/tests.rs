...
use bsmr_build_api::interpreter::rule_defs::transitive_set::globals::register_transitive_set_types;
...
#[test]
fn test_define_transitive_set() -> bsmr_error::Result<()> {
...
#[test]
fn test_hash_transitive_set() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_define_transitive_set_projections() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_create_transitive_set() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_frozen_transitive_sets() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_set_display() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_sets_projection() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_sets_iteration() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_frozen_transitive_sets_iteration() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_args() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_inputs() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_iteration() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_json_projection() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_reduction() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_definition_type() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_type_1() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_type_2() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
    let contents = indoc!(
        r#"
        FooSet = transitive_set()
...
#[test]
fn test_transitive_set_ordering_docs() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_accessors() -> bsmr_error::Result<()> {
    let mut tester = transitive_set_tester();
