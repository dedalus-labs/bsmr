...
use bsmr_interpreter_for_build::attrs::coerce;
use bsmr_interpreter_for_build::attrs::coerce::testing;
...
pub(crate) fn resolution_ctx_with_providers<'v>(
    ...
    impl Ctx<'_, '_> {
        ...
        fn simple_deps() -> (
            ...
            let frozen_provider_env = Module::with_temp_heap(|provider_env| {
                ...
                provider_env.freeze_named(BsmrTestHeapName::frozen_heap_name())
            })
            ...
            let frozen = Module::with_temp_heap(|env| {
                ...
                env.freeze_named(BsmrTestHeapName::frozen_heap_name())
            })
    ...
    impl<'v> AttrResolutionContext<'v> for Ctx<'_, 'v> {
        ...
        fn resolve_query(&mut self, _query: &str) -> bsmr_error::Result<Arc<AnalysisQueryResult>> {
