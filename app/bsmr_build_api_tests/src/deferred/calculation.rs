...
use bsmr_artifact::deferred::key::DeferredHolderKey;
use bsmr_build_api::actions::execute::dice_data::set_fallback_executor_config;
use bsmr_build_api::analysis::AnalysisResult;
use bsmr_build_api::deferred::calculation::DeferredCalculation;
use bsmr_build_api::deferred::types::Deferred;
use bsmr_build_api::deferred::types::DeferredCtx;
use bsmr_build_api::deferred::types::DeferredInput;
use bsmr_build_api::deferred::types::DeferredInputsRef;
use bsmr_build_api::deferred::types::DeferredOutput;
use bsmr_build_api::deferred::types::DeferredRegistry;
use bsmr_build_api::deferred::types::DeferredValue;
use bsmr_common::dice::data::testing::SetTestingIoProvider;
use bsmr_configured::nodes::calculation::ConfiguredTargetNodeKey;
use bsmr_core::base_deferred_key::BaseDeferredKey;
...
impl Deferred for FakeDeferred {
    ...
    ) -> bsmr_error::Result<DeferredValue<Self::Output>> {
...
#[tokio::test]
async fn lookup_deferred_from_analysis() -> bsmr_error::Result<()> {
    let target =
