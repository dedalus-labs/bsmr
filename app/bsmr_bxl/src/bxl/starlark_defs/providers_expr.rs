...
use bsmr_core::provider::label::ProvidersLabelMaybeConfigured;
...
impl ProvidersExpr<ConfiguredProvidersLabel> {
    ...
    async fn unpack_iterable<'c, 'v: 'c>(
        ...
        ctx: &'c BxlContext<'_>,
        dice: &'c mut DiceComputations<'_>,
    ) -> bsmr_error::Result<ProvidersExpr<ConfiguredProvidersLabel>> {
        match arg {
...
impl ProvidersExpr<ProvidersLabel> {
    ...
    fn unpack_iterable<'c, 'v: 'c>(
        ...
        ctx: &'c BxlContext<'_>,
    ) -> bsmr_error::Result<ProvidersExpr<ProvidersLabel>> {
        match arg {
