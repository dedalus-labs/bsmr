...
use bsmr_action_impl::dynamic::attrs_starlark::StarlarkDynamicAttrType;
use bsmr_action_impl::dynamic::bxl::EVAL_BXL_FOR_DYNAMIC_OUTPUT;
use bsmr_action_impl::dynamic::deferred::DynamicLambdaArgs;
use bsmr_action_impl::dynamic::deferred::DynamicLambdaCtxDataSpec;
use bsmr_action_impl::dynamic::deferred::InputArtifactsMaterialized;
use bsmr_action_impl::dynamic::deferred::dynamic_lambda_ctx_data;
use bsmr_action_impl::dynamic::deferred::invoke_dynamic_output_lambda;
use bsmr_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallable;
use bsmr_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackParam;
use bsmr_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackParamSpec;
use bsmr_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackReturnType;
use bsmr_action_impl::dynamic::new_dynamic_actions_callable;
use bsmr_action_impl::dynamic::params::FrozenDynamicLambdaParams;
    ...
    let (_, futs) = unsafe {
        ...
        scope_and_collect_with_dice(dice_ctx, |dice_ctx, s| {
            s.spawn_cancellable(
                ...
                || Err(bsmr_error!(bsmr_error::ErrorTag::Tier0, "cancelled")),
            )
        })
    }
    .await;
