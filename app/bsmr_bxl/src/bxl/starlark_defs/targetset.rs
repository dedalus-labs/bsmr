...
starlark::register_simple_vtable_entry!(
    StarlarkTargetSet<bsmr_node::nodes::unconfigured::TargetNode>
);
starlark::register_simple_vtable_entry!(
    StarlarkTargetSet<bsmr_node::nodes::configured::ConfiguredTargetNode>
);
starlark::register_simple_vtable_entry!(
    StarlarkTargetSet<bsmr_build_api::actions::query::ActionQueryNode>
);
...
/// A set-like object for managing bsmr target nodes.
///
