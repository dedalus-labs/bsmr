...
use bsmr_build_api::bxl::unconfigured_attribute::CoercedAttrExt;
...
pub(crate) trait NodeAttributeGetter {
    fn get_attr<'v>(&self, key: &str, heap: Heap<'v>) -> bsmr_error::Result<NoneOr<Value<'v>>>;
    fn get_attrs<'v>(
        &self,
        heap: Heap<'v>,
    ) -> bsmr_error::Result<SmallMap<StringValue<'v>, Value<'v>>>;
...
impl NodeAttributeGetter for StarlarkTargetNode {
    ...
    fn get_attrs<'v>(
        ...
        attrs_iter
            ...
            .collect::<bsmr_error::Result<SmallMap<_, _>>>()
    }
