...
use bsmr_core::cells::instance::CellInstance;
use bsmr_core::cells::paths::CellRelativePath;
use bsmr_core::fs::project_rel_path::ProjectRelativePath;
use bsmr_core::pattern::pattern::maybe_split_cell_alias_and_relative_path;
...
) -> bsmr_error::Result<Option<CellPath>> {
...
mod tests {
    ...
    #[test]
    fn test_parse_cell_path_as_file_expr_literal() -> bsmr_error::Result<()> {
