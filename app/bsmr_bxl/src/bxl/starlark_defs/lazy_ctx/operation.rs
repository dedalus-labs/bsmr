...
enum LazyOperation {
    ...
    ConfiguredTargetNode {
        ...
        global_cfg_options: bsmr_error::Result<GlobalCfgOptions>,
    },
...
enum LazyResult {
    ...
    Catch(Box<bsmr_error::Result<LazyResult>>),
}
...
) -> bsmr_error::Result<StarlarkAnalysisResult> {
