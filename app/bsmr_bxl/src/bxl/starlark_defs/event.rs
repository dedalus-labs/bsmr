...
use bsmr_data::StarlarkUserMetadataDictValue;
use bsmr_data::StarlarkUserMetadataListValue;
use bsmr_data::StarlarkUserMetadataValue;
use bsmr_data::starlark_user_metadata_value::Value::BoolValue;
use bsmr_data::starlark_user_metadata_value::Value::DictValue;
...
impl<'v> StarlarkUserEventParser<'v> {
    pub(crate) fn parse(
        ...
        id: &str,
        metadata: Value<'v>,
    ) -> bsmr_error::Result<StarlarkUserEvent> {
    ...
    fn get_metadata_value(
        ...
        k: &str,
        v: Value<'v>,
    ) -> bsmr_error::Result<StarlarkUserMetadataValue> {
