...
//! This module defines the API between validators and Bessemer by specifying
...
pub(crate) fn parse_validation_result(content: &str) -> bsmr_error::Result<ValidationResult> {
