...
impl RelativePath {
    ...
    /// weirdness.
    #[inline]
    pub fn new(s: &str) -> bsmr_error::Result<&RelativePath> {
...
impl RelativePathBuf {
    ...
    pub fn new(s: String) -> bsmr_error::Result<RelativePathBuf> {
        verify_relative_path(&s, false)?;
        Ok(RelativePathBuf(s))
    }
...
pub(super) fn verify_relative_path(rel_path: &str, expect_forward: bool) -> bsmr_error::Result<()> {
