...
impl ForwardRelativePath {
    ...
    #[inline]
    pub fn new<S: ?Sized + AsRef<Path>>(s: &S) -> bsmr_error::Result<&ForwardRelativePath> {
    ...
    pub fn new_trim_trailing_slashes<S: ?Sized + AsRef<Path>>(
        path: &S,
    ) -> bsmr_error::Result<&ForwardRelativePath> {
    ...
    pub fn join_normalized<P: AsRef<RelativePath>>(
        &self,
        path: P,
    ) -> bsmr_error::Result<ForwardRelativePathBuf> {
...
impl ForwardRelativePathBuf {
    #[inline]
    pub fn new(s: String) -> bsmr_error::Result<ForwardRelativePathBuf> {
...
impl<'a> TryFrom<&'a str> for &'a ForwardRelativePath {
    ...
    /// ```
    #[inline]
    fn try_from(s: &'a str) -> bsmr_error::Result<&'a ForwardRelativePath> {
        ForwardRelativePath::new(s)
    }
}
...
impl<'a> TryFrom<&'a Path> for &'a ForwardRelativePath {
    ...
    /// # bsmr_error::Ok(())
    /// ```
    fn try_from(s: &'a Path) -> bsmr_error::Result<&'a ForwardRelativePath> {
        let s = s
            .as_os_str()
            .to_str()
...
impl<'a> TryFrom<&'a RelativePath> for &'a ForwardRelativePath {
    ...
    /// ```
    #[inline]
    fn try_from(p: &'a RelativePath) -> bsmr_error::Result<&'a ForwardRelativePath> {
...
impl TryFrom<String> for ForwardRelativePathBuf {
    ...
    /// ```
    #[inline]
    fn try_from(s: String) -> bsmr_error::Result<ForwardRelativePathBuf> {
...
impl TryFrom<PathBuf> for ForwardRelativePathBuf {
    ...
    /// # bsmr_error::Ok(())
    /// ```
    fn try_from(p: PathBuf) -> bsmr_error::Result<ForwardRelativePathBuf> {
...
impl TryFrom<RelativePathBuf> for ForwardRelativePathBuf {
    ...
    /// ```
    #[inline]
    fn try_from(p: RelativePathBuf) -> bsmr_error::Result<ForwardRelativePathBuf> {
...
mod tests {
    ...
    #[test]
    fn forward_path_is_comparable() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn path_buf_is_clonable() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn relative_path_display_is_readable() -> bsmr_error::Result<()> {
