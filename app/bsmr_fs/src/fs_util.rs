...
/// Bessemer having full control over how FS IO works is beneficial for implementing
/// IO counters and retry policies that are optimized for Bessemer and the EdenFS
            ...
            Ok(v) => {
                if let Some(err) = last_error_kind {
                    ...
                    soft_error!(
                        ...
                        bsmr_error!(bsmr_error::ErrorTag::Input, "{}", err.to_string()),
                        quiet: true
                    )
                    .ok();
                }
...
pub fn create_dir_all<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<()> {
...
pub fn read_dir_if_exists<P: AsRef<AbsNormPath>>(path: P) -> bsmr_error::Result<Option<ReadDir>> {
    let _guard = IoCounterKey::ReadDir.guard();
    let path = path.as_ref();
...
pub fn try_exists<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<bool> {
...
pub fn symlink_metadata_if_exists<P: AsRef<AbsPath>>(
    path: P,
) -> bsmr_error::Result<Option<fs::Metadata>> {
...
pub fn read_to_string_if_exists<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<Option<String>> {
    let _guard = IoCounterKey::Read.guard();
...
/// Read a file, if it exists. Returns `None` when the file does not exist.
pub fn read_if_exists<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<Option<Vec<u8>>> {
    let _guard = IoCounterKey::Read.guard();
...
pub fn canonicalize_if_exists<P: AsRef<AbsPath>>(
    path: P,
) -> bsmr_error::Result<Option<AbsNormPathBuf>> {
    let _guard = IoCounterKey::Canonicalize.guard();
...
pub fn simplified(path: &AbsPath) -> bsmr_error::Result<&AbsPath> {
...
pub fn disk_space_stats<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<DiskSpaceStats> {
    #[cfg(not(windows))]
    fn disk_space_stats_impl(path: &AbsPath) -> bsmr_error::Result<DiskSpaceStats> {
        use std::ffi::CString;
...
pub fn create_file_if_not_exists<P: AsRef<AbsPath>>(
    path: P,
) -> bsmr_error::Result<Option<FileWriteGuard>> {
...
pub fn open_file_if_exists<P: AsRef<AbsPath>>(
    path: P,
) -> bsmr_error::Result<Option<FileReadGuard>> {
    let guard = IoCounterKey::Read.guard();
    let Some(file) =
...
/// Wrapper for fs_util functions that convert to bsmr_error::Result without categorization.
...
pub mod uncategorized {
    ...
    pub fn symlink<P, Q>(original: P, link: Q) -> bsmr_error::Result<()>
    where
        P: AsRef<Path>,
        Q: AsRef<AbsPath>,
    {
    ...
    pub fn set_current_dir<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<()> {
        super::set_current_dir(path).uncategorized()
    }

    pub fn create_dir<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<()> {
        super::create_dir(path).uncategorized()
    }

    pub fn create_dir_if_not_exists<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<()> {
        super::create_dir_if_not_exists(path).uncategorized()
    }

    pub fn read_dir<P: AsRef<AbsNormPath>>(path: P) -> bsmr_error::Result<ReadDir> {
        super::read_dir(path).uncategorized()
    }

    pub fn remove_file<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<()> {
        super::remove_file(path).uncategorized()
    }

    pub fn copy<P: AsRef<AbsPath>, Q: AsRef<AbsPath>>(from: P, to: Q) -> bsmr_error::Result<u64> {
        super::copy(from, to).uncategorized()
    }

    pub fn read_link<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<PathBuf> {
        super::read_link(path).uncategorized()
    }

    pub fn rename<P: AsRef<AbsPath>, Q: AsRef<AbsPath>>(from: P, to: Q) -> bsmr_error::Result<()> {
    ...
    pub fn metadata<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<fs::Metadata> {
        super::metadata(path).uncategorized()
    }

    pub fn symlink_metadata<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<fs::Metadata> {
    ...
    pub fn set_executable<P: AsRef<AbsPath>>(path: P, executable: bool) -> bsmr_error::Result<()> {
        super::set_executable(path, executable).uncategorized()
    }

    pub fn remove_dir_all<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<()> {
        super::remove_dir_all(path).uncategorized()
    }

    pub fn remove_all<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<()> {
        super::remove_all(path).uncategorized()
    }

    pub fn read<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<Vec<u8>> {
        super::read(path).uncategorized()
    }

    pub fn read_to_string<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<String> {
        super::read_to_string(path).uncategorized()
    }

    pub fn canonicalize<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<AbsNormPathBuf> {
        super::canonicalize(path).uncategorized()
    }

    pub fn remove_dir<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<()> {
        super::remove_dir(path).uncategorized()
    }

    pub fn create_file<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<FileWriteGuard> {
        super::create_file(path).uncategorized()
    }

    pub fn open_file<P: AsRef<AbsPath>>(path: P) -> bsmr_error::Result<FileReadGuard> {
...
mod tests {
    ...
    #[test]
    fn if_exists_read_dir() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn create_and_remove_symlink_dir() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn create_and_remove_symlink_file() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = tempdir.path().join("root");
        let root = AbsPath::new(&root)?;
        fs_util::create_dir_all(root)?;
    ...
    #[test]
    fn test_symlink_with_target_length_over_max_path() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn symlink_to_file_which_doesnt_exist() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn symlink_with_missing_parent() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
        ...
        let err = bsmr_error::Error::from(res.unwrap_err());
        assert!(err.has_tag(ErrorTag::MissingInputPath));
        Ok(())
    }

    #[test]
    fn symlink_to_symlinked_dir() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn relative_symlink_to_nonexistent_file() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn relative_symlink_to_nonexistent_dir() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn relative_symlink_from_symlinked_dir_windows() -> bsmr_error::Result<()> {
        if !cfg!(windows) {
            return Ok(());
        }
    ...
    #[test]
    fn absolute_symlink_to_nonexistent_file_in_nonexistent_dir() -> bsmr_error::Result<()> {
        // tmp -- dir1 (doesn't exists) -- file1 (doesn't exist)
        //     \
    ...
    #[test]
    fn remove_file_removes_symlink_to_directory() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn remove_file_does_not_remove_directory() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
        let dir_path = root.join("dir");
    ...
    #[test]
    fn remove_file_broken_symlink() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
    ...
    #[test]
    fn remove_file_non_existing_file() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn remove_all_nonexistent() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn remove_all_regular() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn remove_all_dir() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn remove_all_broken_symlink() -> bsmr_error::Result<()> {
        fn ls(path: &Path) -> bsmr_error::Result<Vec<PathBuf>> {
    ...
    #[cfg(unix)]
    #[test]
    fn remove_all_path_contains_regular_file() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn remove_dir_all_does_not_remove_file() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn test_read_to_string_if_exists() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
        let f1 = root.join("f1");
        let f2 = root.join("f2");
    ...
    #[test]
    fn test_read_if_exists() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
        let f1 = root.join("f1");
        let f2 = root.join("f2");
    ...
    #[cfg(unix)]
    #[test]
    fn test_remove_all_removes_readonly_path() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn test_create_file_if_not_exists() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn test_disk_space_stats() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
        let root = AbsPath::new(tempdir.path())?;
    ...
    #[test]
    fn test_retry_io() -> bsmr_error::Result<()> {
        use std::io::ErrorKind;
    ...
    #[cfg(unix)]
    #[test]
    fn read_dir_on_file_tags_not_a_directory() -> bsmr_error::Result<()> {
        let tempdir = tempfile::tempdir()?;
    ...
    #[test]
    fn test_io_error_tag() -> bsmr_error::Result<()> {
        ...
        let bsmr_error = file.uncategorized().err().unwrap();
