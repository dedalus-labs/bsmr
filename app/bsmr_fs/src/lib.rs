...
//! Project-agnostic filesystem utilities for Bessemer.
//!
//! This crate contains filesystem types and utilities that have no knowledge
//! of Bessemer projects, cells, or build artifacts. It provides:
...
//!
//! For project-aware filesystem functionality, see the `bsmr_core::fs` module.
