...
use bsmr_analysis::attrs::resolve::attr_type::arg::ConfiguredStringWithMacrosExt;
use bsmr_analysis::attrs::resolve::attr_type::dep::DepAttrTypeExt;
...
use bsmr_build_api::artifact_groups::promise::PromiseArtifactAttr;
...
use bsmr_build_api::interpreter::rule_defs::artifact::starlark_promise_artifact::StarlarkPromiseArtifact;
...
impl AnonTargetDependents {
    ...
    ) -> bsmr_error::Result<AnonTargetDependents> {
    ...
    ) -> bsmr_error::Result<AnonTargetDependentAnalysisResults<'v>> {
