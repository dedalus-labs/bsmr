...
use bsmr_node::attrs::coerced_attr_with_type::CoercedAttrWithType;
...
use bsmr_node::attrs::json::ToJsonWithContext;
...
impl ToJsonWithContext for AnonTargetAttr {
    fn to_json(&self, ctx: &AttrFmtContext) -> bsmr_error::Result<serde_json::Value> {
        match self {
