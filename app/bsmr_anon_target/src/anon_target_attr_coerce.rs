...
use bsmr_build_api::interpreter::rule_defs::provider::dependency::Dependency;
use bsmr_build_api::interpreter::rule_defs::resolved_macro::ResolvedStringWithMacros;
...
use bsmr_node::attrs::attr_type::AttrTypeInner;
...
use bsmr_node::attrs::attr_type::dict::DictAttrType;
use bsmr_node::attrs::attr_type::dict::DictLiteral;
use bsmr_node::attrs::attr_type::list::ListAttrType;
use bsmr_node::attrs::attr_type::list::ListLiteral;
use bsmr_node::attrs::attr_type::one_of::OneOfAttrType;
...
pub trait AnonTargetAttrTypeCoerce {
    fn coerce_item(&self, ctx: &AnonAttrCtx, value: Value) -> bsmr_error::Result<AnonTargetAttr>;
}
...
fn to_anon_target_any(value: Value, ctx: &AnonAttrCtx) -> bsmr_error::Result<AnonTargetAttr> {
    if value.is_none() {
        Ok(AnonTargetAttr::None)
