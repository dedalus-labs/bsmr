...
use bsmr_node::nodes::eval_result::is_generated_target;
...
impl ServerCommandTemplate for CompleteServerCommand {
    type StartEvent = bsmr_data::CompleteCommandStart;
    type EndEvent = bsmr_data::CompleteCommandEnd;
    type Response = bsmr_cli_proto::new_generic::CompleteResponse;
