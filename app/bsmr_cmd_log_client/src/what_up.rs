...
use bsmr_client_ctx::subscribers::superconsole::CUTOFFS;
use bsmr_client_ctx::subscribers::superconsole::StatefulSuperConsole;
use bsmr_client_ctx::subscribers::superconsole::SuperConsoleConfig;
use bsmr_client_ctx::subscribers::superconsole::SuperConsoleState;
use bsmr_client_ctx::subscribers::superconsole::session_info::SessionInfoComponent;
use bsmr_client_ctx::subscribers::superconsole::timed_list::TimedList;
        ...
        while let Ok(Some(event)) = events.try_next().await {
            match event {
                ...
                StreamValue::Result(result) => {
                    ...
                    bsmr_client_ctx::eprintln!("No open spans to render when log ended")?;
...
impl WhatUpCommand {
    fn component(state: &SuperConsoleState) -> impl Component<Error = bsmr_error::Error> + '_ {
...
impl Clock for WhatupClock {
    fn event_timestamp_for_tick(&mut self, _tick: bsmr_client_ctx::ticker::Tick) -> EventTimestamp {
