...
//! Provides the (daemon-side) support for bsmr's starlark debugging.
//!
...
//! helper [bsmr_interpreter::factory::StarlarkEvaluatorProvider]).
//!
...
use bsmr_interpreter::starlark_debug::StarlarkDebuggerHandle;
