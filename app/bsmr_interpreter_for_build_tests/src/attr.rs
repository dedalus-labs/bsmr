...
use bsmr_interpreter_for_build::attrs::coerce::ctx::BuildAttrCoercionContext;
...
use bsmr_node::attrs::hacks::value_to_string;
...
#[test]
fn string_works() -> bsmr_error::Result<()> {
...
#[test]
fn boolean_works() -> bsmr_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn test_attr_module_registered() -> bsmr_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
        def test():
...
#[test]
fn list_works() -> bsmr_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
        frozen = attrs.list(
...
#[test]
fn enum_works() -> bsmr_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_coercer_coerces() -> bsmr_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn dep_works() -> bsmr_error::Result<()> {
...
#[test]
fn source_works() -> bsmr_error::Result<()> {
    let mut t = Tester::new().unwrap();
    t.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn coercing_src_to_path_works() -> bsmr_error::Result<()> {
