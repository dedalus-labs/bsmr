...
pub(crate) fn codegen(parsed: Parsed) -> syn::Result<TokenStream> {
    ...
    let result = quote! {
        ...
        mod #mod_name {
            ...
            use ::bsmr_query::__derive_refs::ref_cast::RefCast;
            use ::bsmr_query::__derive_refs::bsmr_query_parser::{BinaryOp, SpannedExpr};
            use ::bsmr_query::__derive_refs::indexmap::indexmap;
            use ::bsmr_query::__derive_refs::async_trait::async_trait;

            use super::*;
            use ::bsmr_query::query::{
