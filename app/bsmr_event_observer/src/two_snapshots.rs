...
pub struct TwoSnapshots {
    pub penultimate: Option<(SystemTime, bsmr_data::Snapshot)>,
    pub last: Option<(SystemTime, bsmr_data::Snapshot)>,
}

impl TwoSnapshots {
    pub fn update(&mut self, timestamp: SystemTime, snapshot: &bsmr_data::Snapshot) {
    ...
    fn per_micro_second(&self, field: impl Fn(&bsmr_data::Snapshot) -> u64) -> Option<u64> {
...
mod tests {
    ...
    fn test_cpu_percents() {
        ...
        two_snapshots.update(
            t0,
            &bsmr_data::Snapshot {
                bsmr_user_cpu_us: 100,
                bsmr_system_cpu_us: 200,
                ..Default::default()
            },
        );
        assert_eq!(None, two_snapshots.cpu_percents());
        ...
        two_snapshots.update(
            ...
            &bsmr_data::Snapshot {
                bsmr_user_cpu_us: 6_000_100,
                bsmr_system_cpu_us: 8_000_200,
                ..Default::default()
            },
        );
