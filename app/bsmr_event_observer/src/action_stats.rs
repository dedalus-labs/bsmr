...
impl ActionStats {
    ...
    pub fn update(&mut self, action: &bsmr_data::ActionExecutionEnd) {
...
pub fn was_local_action(action: &bsmr_data::ActionExecutionEnd) -> bool {
    action.execution_kind() == bsmr_data::ActionExecutionKind::Local
        || action.execution_kind() == bsmr_data::ActionExecutionKind::LocalWorker
}

pub fn scheduling_mode(action: &bsmr_data::ActionExecutionEnd) -> Option<SchedulingMode> {
    action
        .scheduling_mode
...
pub fn was_fallback_action(action: &bsmr_data::ActionExecutionEnd) -> bool {
    ...
    fn test_file_change_invalidation_source() {
        ...
        let action_execution_end = ActionExecutionEnd {
            ...
            invalidation_info: Some(bsmr_data::CommandInvalidationInfo {
                changed_file: Some(bsmr_data::command_invalidation_info::InvalidationSource {}),
                ..Default::default()
            }),
            ..Default::default()
        };
