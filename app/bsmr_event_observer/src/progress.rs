...
use bsmr_data::AnalysisEnd;
use bsmr_data::AnalysisStageStart;
use bsmr_data::AnalysisStart;
use bsmr_data::ExecutorStageStart;
use bsmr_data::LoadBuildFileEnd;
use bsmr_data::LocalStage;
use bsmr_data::ReStage;
use bsmr_data::analysis_stage_start;
use bsmr_data::executor_stage_start;
use bsmr_data::instant_event;
use bsmr_data::local_stage;
...
mod tests {
    ...
    #[test]
    fn test_span_map() -> bsmr_error::Result<()> {
