...
pub enum Applicability {
    ...
    Internal,
    /// Only used in self-tests of bsmr
    Testing,
}
...
mod tests {
    ...
    #[test]
    fn test_env_info() {
        let _ignore = bsmr_env!("TEST_VAR_1", applicability = internal);
        let _ignore = bsmr_env!("TEST_VAR_2", type = u32, default=20);
    ...
    #[test]
    fn test_ty_short() {
        let _ignore = bsmr_env!("TEST_VAR_TY_SHORT");
        let var = ENV_INFO
            .iter()
