    ...
    H: DirectoryDigest,
{
    ...
    pub fn merge_with_compatible_leaves(&mut self, other: Self) -> Result<(), DirectoryMergeError> {
        if !bsmr_core::faster_directories::is_enabled() {
...
mod tests {
    ...
    #[test]
    fn test_insert() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_merge() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_merge_overwrite() -> bsmr_error::Result<()> {
        let mut a = TestDirectoryBuilder::empty();
        a.insert(path("a/b"), DirectoryEntry::Leaf(NopEntry))?;
    ...
    #[test]
    fn test_merge_conflict() -> bsmr_error::Result<()> {
        let mut a = TestDirectoryBuilder::empty();
    ...
    #[test]
    fn test_copy_on_write() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_mkdir() -> bsmr_error::Result<()> {
        let mut b = TestDirectoryBuilder::empty();
    ...
    #[test]
    fn test_mkdir_overwrite() -> bsmr_error::Result<()> {
        let mut b = TestDirectoryBuilder::empty();
        b.insert(path("a/b"), DirectoryEntry::Leaf(NopEntry))?;
