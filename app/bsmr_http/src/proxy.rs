...
fn env_to_string(env: &'static str) -> bsmr_error::Result<Option<String>> {
    std::env::var_os(env)
...
fn noproxy_from_env(scheme: Scheme) -> bsmr_error::Result<Option<NoProxy>> {
...
pub(super) fn https_proxy_from_env() -> bsmr_error::Result<Option<Proxy>> {
...
pub(super) fn http_proxy_from_env() -> bsmr_error::Result<Option<Proxy>> {
