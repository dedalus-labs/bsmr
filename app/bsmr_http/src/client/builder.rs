...
use bsmr_certs::certs::find_internal_cert;
use bsmr_certs::certs::supports_vpnless;
use bsmr_certs::certs::tls_config_with_single_cert;
use bsmr_certs::certs::tls_config_with_system_roots;
...
impl HttpClientBuilder {
    ...
    pub async fn oss() -> bsmr_error::Result<Self> {
    ...
    pub async fn internal() -> bsmr_error::Result<Self> {
        let mut builder = Self::https_with_system_roots().await?;
        if supports_vpnless() {
    ...
    pub async fn https_with_system_roots() -> bsmr_error::Result<Self> {
    ...
    pub fn with_proxy_from_env(&mut self) -> bsmr_error::Result<&mut Self> {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_default_builder() -> bsmr_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_supports_vpnless_set_true() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_http2_option() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_with_max_redirects_overrides_default() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_builder_with_proxy_adds_proxy() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_set_connect_timeout() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_set_connect_and_read_timeouts() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
        builder
