...
trait UriWithRedirect {
    fn with_redirect(&self, location: &Uri) -> bsmr_error::Result<Uri>;
...
impl PendingRequest {
    ...
    pub(super) fn to_request(&self) -> bsmr_error::Result<Request<Bytes>> {
...
impl<B> RedirectEngine<B> {
    ...
    fn update_and_create_request(&mut self) -> bsmr_error::Result<Option<Request<Bytes>>> {
