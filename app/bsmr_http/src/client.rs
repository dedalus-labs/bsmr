...
const DEFAULT_USER_AGENT: &str = "Bessemer";
...
pub async fn to_bytes(body: BoxStream<'_, hyper::Result<Bytes>>) -> bsmr_error::Result<Bytes> {
...
mod tests {
    ...
    #[test]
    fn test_change_scheme_to_http_succeeds() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn test_change_scheme_to_http_no_effect() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_simple_get_success() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_simple_put_success() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_simple_post_success() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![
    ...
    #[tokio::test]
    async fn test_404_not_found_is_error() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(request::method_path("GET", "/foo"))
    ...
    #[tokio::test]
    async fn test_count_response_size() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(request::method_path("GET", "/foo"))
    ...
    #[tokio::test]
    async fn test_follows_redirects() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
    ...
    #[tokio::test]
    async fn test_head_changes_to_get_on_redirect() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        // Chain of two redirects /foo -> /bar -> /baz.
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_post_gets_redirected() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        // Redirect /foo -> /bar
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_too_many_redirects_fails() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
    ...
    mod unix {
        ...
        impl UnixSocketProxyServer {
            pub async fn new() -> bsmr_error::Result<Self> {
    ...
    #[cfg(unix)]
    #[tokio::test]
    async fn test_proxies_through_unix_socket_when_set() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_x2p_error_response_is_forbidden_host() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        let url = test_server.url("/foo");
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_x2p_error_response_is_access_denied() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        let url = test_server.url("/foo");
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_x2p_error_response_is_generic_error() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_concurrency_limit() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(request::method_path("GET", "/foo"))
...
mod proxy_tests {
    ...
    const HEADER_SLEEP_DURATION_MS: &str = "x-bsmr-test-proxy-sleep-duration-ms";
    ...
    impl ProxyServer {
        async fn new() -> bsmr_error::Result<Self> {
        ...
        fn uri(&self) -> bsmr_error::Result<http::Uri> {
            http::Uri::builder()
                .scheme("http")
    ...
    #[tokio::test]
    async fn test_uses_http_proxy() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![
    ...
    #[tokio::test]
    async fn test_uses_http_proxy_with_no_scheme_in_proxy_uri() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![
    ...
    #[tokio::test]
    async fn test_does_not_proxy_when_no_proxy_matches() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![request::method_path("GET", "/foo")])
    ...
    #[tokio::test]
    async fn test_proxies_when_no_proxy_does_not_match() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![
    ...
    #[tokio::test]
    async fn test_timeout() -> bsmr_error::Result<()> {
        bsmr_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        let proxy_server = ProxyServer::new().await?;
