...
use bsmr_common::pattern::parse_from_cli::parse_patterns_from_cli_args_typed;
use bsmr_core::pattern::package::PackagePredicate;
use bsmr_core::pattern::pattern::ParsedPatternPredicate;
...
impl ProfileRegex {
    pub fn new(patterns: &[String]) -> bsmr_error::Result<Self> {
...
impl Key for StarlarkProfilerConfigurationResolvedKey {
    type Value = bsmr_error::Result<Arc<StarlarkProfilerConfigurationResolved>>;
...
impl ProjectionKey for StarlarkProfileModeForKind {
    ...
    type Value = bsmr_error::Result<StarlarkProfileMode>;
    ...
    fn compute(
        &self,
        configuration: &bsmr_error::Result<Arc<StarlarkProfilerConfigurationResolved>>,
        _ctx: &DiceProjectionComputations,
    ) -> bsmr_error::Result<StarlarkProfileMode> {
