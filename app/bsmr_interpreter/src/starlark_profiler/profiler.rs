...
pub struct ProfilerData {
    ...
    profile_data: Option<bsmr_error::Result<ProfileData>>,
}
...
impl ProfilerData {
    ...
    pub(crate) fn initialize(&mut self, eval: &mut Evaluator) -> bsmr_error::Result<bool> {
    ...
    ) -> bsmr_error::Result<Option<Arc<StarlarkProfileDataAndStats>>> {
