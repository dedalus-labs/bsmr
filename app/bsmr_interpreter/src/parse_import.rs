...
mod tests {
    ...
    #[test]
    fn root_package() -> bsmr_error::Result<()> {
        assert_eq!(
    ...
    #[test]
    fn cell_package() -> bsmr_error::Result<()> {
        assert_eq!(
    ...
    #[test]
    fn package_relative() -> bsmr_error::Result<()> {
        assert_eq!(
            path("cell1", "package/path", "import.bzl"),
            parse_import(
                &resolver(),
    ...
    #[test]
    fn missing_colon() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn empty_filename() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn bad_alias() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn file_relative_import_given_relative_paths_allowed() -> bsmr_error::Result<()> {
        assert_eq!(
    ...
    #[test]
    fn cell_relative_import_given_relative_paths_allowed() -> bsmr_error::Result<()> {
    ...
    #[test]
    fn regular_import_given_relative_paths_allowed() -> bsmr_error::Result<()> {
        assert_eq!(
            path("cell1", "package/path", "import.bzl"),
            parse_import(
                &resolver(),
    ...
    #[test]
    fn allows_non_at_symbols() -> bsmr_error::Result<()> {
        assert_eq!(
            path("cell1", "package/path", "import.bzl"),
    ...
    #[test]
    fn fails_relative_import_if_disallowed() -> bsmr_error::Result<()> {
