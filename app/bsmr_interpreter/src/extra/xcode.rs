...
impl XcodeVersionInfo {
    ...
    pub(crate) fn from_plist(plist_path: &Path) -> bsmr_error::Result<Option<Self>> {
        ...
        let plist = match plist {
            ...
            Err(e) => {
                return Err(from_any_with_tag(e, bsmr_error::ErrorTag::Tier0)
    ...
    pub fn from_version_and_build(version_and_build: &str) -> bsmr_error::Result<Self> {
