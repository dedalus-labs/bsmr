...
pub static FROZEN_RULE_GET_IMPL: LateBinding<fn(FrozenValue) -> bsmr_error::Result<FrozenValue>> =
    LateBinding::new("FROZEN_RULE_GET_IMPL");

pub static FROZEN_PROMISE_ARTIFACT_MAPPINGS_GET_IMPL: LateBinding<
    fn(FrozenValue) -> bsmr_error::Result<SmallMap<FrozenStringValue, FrozenValue>>,
