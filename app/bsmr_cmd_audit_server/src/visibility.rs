...
use bsmr_cmd_audit_client::visibility::AuditVisibilityCommand;
...
use bsmr_node::nodes::lookup::TargetNodeLookup;
...
async fn verify_visibility(
    ...
    bsmr_client_ctx::eprintln!("audit visibility succeeded")?;
    Ok(())
}
...
impl ServerAuditSubcommand for AuditVisibilityCommand {
    async fn server_execute(
        ...
        _stdout: PartialResultDispatcher<bsmr_cli_proto::StdoutBytes>,
