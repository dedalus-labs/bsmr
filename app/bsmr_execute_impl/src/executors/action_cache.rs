...
use bsmr_execute::execute::action_digest::ActionDigestKind;
...
use bsmr_execute::re::remote_action_result::ActionCacheResult;
...
impl CacheType {
    fn to_proto(&self) -> bsmr_data::CacheType {
        match self {
            CacheType::ActionCache => bsmr_data::CacheType::ActionCache,
            CacheType::RemoteDepFileCache(_) => bsmr_data::CacheType::RemoteDepFileCache,
        }
    }
}
