...
use bsmr_execute::materialize::materializer::DeclareMatchOutcome;
use bsmr_execute::materialize::materializer::DeferredMaterializerExtensions;
use bsmr_execute::materialize::materializer::EagerMaterializationGuard;
...
struct TtlRefreshHistoryEntry {
    at: DateTime<Utc>,
    outcome: Option<bsmr_error::Result<()>>,
}
...
impl From<bsmr_error::Error> for MaterializeEntryError {
    fn from(e: bsmr_error::Error) -> MaterializeEntryError {
        Self::Error(e)
    }
}
...
impl<T: IoHandler + Allocative> Materializer for DeferredMaterializerAccessor<T> {
    ...
    fn add_snapshot_stats(&self, snapshot: &mut bsmr_data::Snapshot) {
...
impl DeferredMaterializerAccessor<DefaultIoHandler> {
    ...
    pub fn new(
        ...
        let materializer_state_info = bsmr_data::MaterializerStateInfo {
