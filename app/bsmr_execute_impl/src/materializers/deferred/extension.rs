...
use bsmr_execute::materialize::materializer::DeferredMaterializerEntry;
...
struct Fsck {
    ...
    /// materializer command thread.
    #[derivative(Debug = "ignore")]
    sender: UnboundedSender<(ProjectRelativePathBuf, bsmr_error::Error)>,
}
...
#[derivative(Debug)]
struct RefreshTtls {
    sender: Sender<Option<JoinHandle<bsmr_error::Result<()>>>>,
    min_ttl: i64,
}
