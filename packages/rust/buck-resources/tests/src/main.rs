...
fn main() {
    ...
    let hello_path = buck_resources::get("bsmr/packages/rust/buck-resources/hello_binary").unwrap();
...
fn resource_exists_in_unittest() {
    buck_resources::get("bsmr/packages/rust/buck-resources/hello_binary").unwrap();
}
