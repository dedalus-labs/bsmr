...
fn main() {
    ...
    let hello_path = bsmr_resources::get("bsmr/packages/rust/bsmr-resources/hello_binary").unwrap();
...
fn resource_exists_in_unittest() {
    bsmr_resources::get("bsmr/packages/rust/bsmr-resources/hello_binary").unwrap();
}
