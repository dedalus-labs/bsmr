...
function brief(path: string): string {
	...
	const known = new Map([
		...
		[".github/actions/ci/post-merge-receipts/dist/index.js", "Runs the generated post-merge receipt action."],
		[".github/actions/ci/post-merge-receipts/src/index.ts", "Implements the post-merge receipt action."],
		...
		["ci/cli-reference.test.ts", "Verifies CLI reference drift detection."],
		["ci/cli-reference.ts", "Checks the committed CLI reference against the built parser."],
		...
		["ci/dependabot.test.ts", "Verifies the generated dependency-update policy."],
		["ci/dependabot.ts", "Generates the repository dependency-update policy."],
		...
		["ci/license-provenance.ts", "Derives source ownership from Bessemer's immutable upstream fork boundary."],
		...
		["ci/osv-audit.test.ts", "Verifies fail-closed Rust vulnerability filtering."],
		["ci/osv-audit.ts", "Defines the generated Rust dependency-audit action."],
		["ci/post-merge.test.ts", "Verifies exact post-merge deployment receipts."],
		["ci/post-merge.ts", "Defines the generated post-merge deployment receipt workflow."],
		["ci/release-publish.ts", "Publishes a complete product release transactionally."],
		["ci/release-state.ts", "Validates product versions against immutable GitHub releases."],
		["ci/release-sync.test.ts", "Verifies release branch synchronization."],
		["ci/release-sync.ts", "Synchronizes and commits release metadata."],
		["ci/release.test.ts", "Verifies the release version and workflow boundary."],
		["ci/release-please.ts", "Prepares release pull requests after immutable publication."],
		["ci/release-version.ts", "Synchronizes the product version across release and Cargo metadata."],
		["ci/rust-build-dependencies.mjs", "Runs the generated Rust dependency graph adapter."],
		["ci/verify-sha256.test.ts", "Verifies downloaded artifact checksum enforcement."],
