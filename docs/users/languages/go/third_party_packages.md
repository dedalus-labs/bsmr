...
- Use
  ...
  to generate `BUILD.bsmr` files for your dependencies
...
3. Run `gobuckify` to generate `BUILD.bsmr` files for your dependencies:
...
{
  "buck": {
    "preambule": "# Generated by gobuckify\n", // Added to the top of each BUILD.bsmr file
