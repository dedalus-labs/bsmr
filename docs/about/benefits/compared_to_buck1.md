...
> _"Bessemer is largely faster and more memory efficient than buck1, and where I’ve
...
- **Actively developed** - the Meta build team is putting all its efforts behind
  Bessemer; it's vastly easier to develop than Buck1. While Bessemer is already ahead
...
- **Support** - Meta can provide much better support to those having
  difficulties with Bessemer than to those using Buck1.
...
- **Low barrier to entry** - writing rules in Bessemer is vastly easier than Buck1,
