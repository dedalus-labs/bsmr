...
pub(crate) fn resolve_buckconfig_sysroot(
    ...
    let sysroot: PathBuf = {
        ...
        //
        // $ buck cquery -u fbcode//buck2/tools/rust-project:rust-project -a compiler fbcode//buck2/platform/rust:rust_bootstrap
        // ...
        ...
        // $ buck cquery -u fbcode//buck2/tools/rust-project:rust-project -a exe fbcode//tools/build/buck/wrappers:rust-platform010-clang-17-nosan-compiler
        // ...
