...
class TestDistLtoOpt(unittest.TestCase):
    ...
    def test_fbcc_prefix_end_tp2_with_log_fbcc(self):
        ...
        opt_args = [
            "--",
            "bsmr-out/fbcc",
            "--cc=fbcode/third-party-bsmr/platform010/build/llvm-fb/19/bin/clang++",
            "--log-fbcc=False",
    ...
    def test_fbcc_prefix_end_bsmrified_no_log_fbcc(self):
        """Bsmrified toolchain: --target is NOT consumed by fbcc and must be
        excluded from prefix to avoid breaking -cc1 mode."""
        opt_args = [
            "--",
            "bsmr-out/fbcc",
            "--cc=bsmr-out/default/art/fbsource/third-party/llvm-fb/19/__build/bin/clang++__/out/clang++",
            "--target=x86_64-redhat-linux-gnu",
            "-nostdinc",
            "-nostdinc++",
        ]
    ...
    def test_filter_flags_hhvm_case_rev_0f8618f31(self):
        inputs = [
            ...
            "-idirafter",
            "-idirafter",
            "fbcode/third-party-bsmr/platform010/build/glibc/include",
            "-idirafter",
            "fbcode/third-party-bsmr/platform010/build/kernel-headers/include",
            "-Bfbcode/third-party-bsmr/platform010/build/binutils/x86_64-facebook-linux/bin",
            "--cflag=--target=x86_64-redhat-linux-gnu",
            "-Bfbcode/third-party-bsmr/platform010/build/glibc/lib",
            "-Bfbcode/third-party-bsmr/platform010/tools/gcc/lib/gcc/x86_64-redhat-linux-gnu/trunk",
            "-Lfbcode/third-party-bsmr/platform010/build/libgcc/lib/gcc/x86_64-facebook-linux/trunk",
            "-Wl,-nostdlib",
            ...
            "-nodefaultlibs",
            "--target=x86_64-redhat-linux-gnu",
            "-Lfbcode/third-party-bsmr/platform010/build/glibc/lib",
            "-Lfbcode/third-party-bsmr/platform010/build/libgcc/lib",
            "-Wl,-z,notext",
            "-Wl,-z,relro",
            "-Wl,--gc-sections",
            "-fuse-ld=lld",
    ...
    def test_filter_flags_unicorn_case_rev_0f8618f31(self):
        inputs = [
            ...
            "--build-info-rule-type=cpp_binary",
            "-flto=thin",
            "-Wl,-plugin-opt,sample-profile=bsmr-out/default/gen/fbcode/40fc99293b37c503/fdo/autofdo/default_profile/__autofdo__/out/profile",
            "-Wl,-plugin-opt,-function-sections",
            "-Wl,-plugin-opt,-profile-guided-section-prefix=false",
            "-Wl,-plugin-opt,-generate-type-units",
            "-Wl,-plugin-opt,-enable-lto-ir-verification=false",
            ...
            "-Xlinker",
            "--start-group",
            "fbcode/third-party-bsmr/platform010/build/IntelComposerXE/mkl/lib/intel64/libmkl_intel_lp64.a",
            "fbcode/third-party-bsmr/platform010/build/IntelComposerXE/mkl/lib/intel64/libmkl_core.a",
            "fbcode/third-party-bsmr/platform010/build/IntelComposerXE/mkl/lib/intel64/libmkl_intel_thread.a",
            "-Xlinker",
            "--end-group",
            "-lpthread",
            "-Xlinker",
        ...
        self.assertListEqual(
            ...
            [
                ...
                "-fdata-sections",
                "-fuse-ld=lld",
                "-fprofile-sample-use=bsmr-out/default/gen/fbcode/40fc99293b37c503/fdo/autofdo/default_profile/__autofdo__/out/profile",
                "-mllvm",
                "-profile-guided-section-prefix=false",
                "-mllvm",
                "-generate-type-units",
