...
Note: If you set this parameter, you must setup your NDK, otherwise Bsmr build will fail.""",
        ),
...
for how to resolve duplicate classes using this attribute.""",
        ...
        "use_split_dex": attrs.bool(
            default = False,
            doc = """If this argument is True, Bsmr enables multidex support for the output APK. \
...
android_build_config = prelude_rule(
    ...
    examples = """
        ...
        #
        # Note that the output of :build_config_release_values will be cached by Bsmr.
        # Assuming that generate_release_build_config.py depends on state that is not
        # expressed by its deps (which violates a fundamental invariant in Bsmr!), a
    ...
    attrs = (
        # @unsorted-dict-items
        {
            ...
            "resources": attrs.list(
                ...
                **Note:** Bsmr uses the `src_roots` property in
                 `.bsmr`
...
apk_genrule = prelude_rule(
    ...
    docs = """
        ...
        produce APKs, so commands like `bsmr install` or
         `bsmr uninstall` still work. Additionally,
    ...
    attrs = (
        ...
        | {
            ...
            "robolectric_runtime_dependency": attrs.option(
                ...
                default = None,
                doc = """
                Robolectric only runs in offline mode with bsmr. Specify the relative
