...
# VSGO: Visual Studio project generation for bsmr targets

VSGO is a project generator that generates Visual Studio project and solution
files given bsmr target labels or patterns, with full functional IntelliSense
and build/run/debug setup.

The majority of heavy lifting is implemented in
[BXL](https://oss.dedaluslabs.ai/bsmr/developers/bxl/), Bsmr Extension Language, which
...
browse, edit, and run/debug your bsmr target.
