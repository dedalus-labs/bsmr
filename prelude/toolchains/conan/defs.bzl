...
* Generators
    ...
    read by another build system to import Conan built packages. Bsmrler is a
...
conan_generate = rule(
    ...
    attrs = {
        ...
        "_adapter": attrs.source(default = "prelude//toolchains/conan:adapter"),
    ...
    doc = "Generate Bessemer import targets for Conan packages using the Bsmrler generator.",
)
...
conan_update = rule(
    ...
    attrs = {
        "conan_generate": attrs.source(doc = "The targets generated by Bsmrler."),
