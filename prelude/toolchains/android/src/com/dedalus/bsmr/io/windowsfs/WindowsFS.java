...
package com.dedalus.bsmr.io.windowsfs;
      ...
      if (failureDueToDevModeNotEnabled) {
        message +=
            ". You seem to be running Win 10 Creator or later OS with no Developer Mode"
                ...
                + " Running Bsmr in elevated mode will also allow symlink creation.";
        ...
        message +=
            ". You are running an OS earlier than Windows 10 Creator. Either upgrade to a\r\n"
                + "post-Creator version and enable Developer Mode, or run Bsmr in elevated mode\r\n"
                + "for symlink creation to work.\r\n"
                + "See https://dev.bsmr.build/setup/getting_started.html for more details.";
      }
