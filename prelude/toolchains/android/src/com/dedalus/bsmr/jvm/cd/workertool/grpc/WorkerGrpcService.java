...
package com.dedalus.bsmr.jvm.cd.workertool.grpc;

import com.dedalus.bsmr.core.util.log.Logger;
import com.dedalus.bsmr.jvm.cd.CompilerDaemonRunner;
import com.dedalus.bsmr.jvm.cd.ErrorInterceptor;
import com.dedalus.bsmr.jvm.cd.JvmCDCommand;
import com.dedalus.bsmr.step.StepExecutionResult;
import com.dedalus.bsmr.worker.model.ExecuteCommand;
import com.dedalus.bsmr.worker.model.ExecuteResponse;
import com.dedalus.bsmr.worker.model.WorkerGrpc;
...
public class WorkerGrpcService extends WorkerGrpc.WorkerImplBase {
  ...
  private ExecuteResponse handleCompletedExecution(JvmCDCommand command, StepExecutionResult result)
    ...
    if (!result.isSuccess()) {
      ...
      String stackTrace = "";
      // if there is a compiling error, we don't want to print bsmr stack trace
