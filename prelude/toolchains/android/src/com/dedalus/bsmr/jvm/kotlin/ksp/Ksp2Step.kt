...
import com.dedalus.bsmr.jvm.kotlin.util.getExpandedSourcePaths
...
class Ksp2Step(
  ...
  private fun executeKsp2(
    ...
    val logger = BsmrKsp2Logger(stdErr)
  ...
  private fun getApOptions(): MutableMap<String, String> {
    ...
    if (invokingRule.isSourceOnlyAbi) {
      apOptions["com.dedalus.bsmr.kotlin.generating_abi"] = "true"
    }
    ...
    apOptions["com.dedalus.bsmr.kotlin.ksp_generated_out_path"] = kotlinPluginGeneratedOutFullPath
    return apOptions
  }
