...
public class JavacStep implements IsolatedStep {
  ...
  public JavacStep(
      ...
      RelPath configuredOutput,
      CompilerOutputPathsValue compilerOutputPathsValue) {
    this(state, invokingRule, configuredOutput, false, compilerOutputPathsValue, false);
  }
  ...
  public final StepExecutionResult executeIsolatedStep(IsolatedExecutionContext context)
    ...
    try {
      ResolvedJavac.Invocation invocation =
          state.getJavacInvocation(compilerOutputPathsValue, context, configuredOutput);
