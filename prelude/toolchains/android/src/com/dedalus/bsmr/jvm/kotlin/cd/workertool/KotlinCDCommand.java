...
import com.dedalus.bsmr.cd.model.kotlin.Metadata;
...
import com.dedalus.bsmr.jvm.cd.serialization.kotlin.ActionMetadataSerializer;
import com.dedalus.bsmr.jvm.java.ActionMetadata;
import com.dedalus.bsmr.jvm.kotlin.KotlinStepsBuilder;
import com.dedalus.bsmr.jvm.kotlin.cd.analytics.KotlinCDAnalytics;
import com.dedalus.bsmr.jvm.kotlin.cd.analytics.logger.KotlinCDLogger;
import com.dedalus.bsmr.jvm.kotlin.cd.analytics.logger.KotlinCDLoggerAnalytics;
import com.dedalus.bsmr.jvm.kotlin.cd.workertool.postexecutors.ClassAbiWriter;
import com.dedalus.bsmr.jvm.kotlin.cd.workertool.postexecutors.ClassAbiWriterFactory;
import com.dedalus.bsmr.jvm.kotlin.cd.workertool.postexecutors.PreviousStateWriter;
import com.dedalus.bsmr.jvm.kotlin.cd.workertool.postexecutors.PreviousStateWriterFactory;
import com.dedalus.bsmr.jvm.kotlin.cd.workertool.postexecutors.SkippedCompilationTracker;
import com.dedalus.bsmr.jvm.kotlin.cd.workertool.postexecutors.SkippedCompilationTrackerFactory;
import com.dedalus.bsmr.util.zip.ZipScrubber;
...
public class KotlinCDCommand implements JvmCDCommand {
  ...
  public KotlinCDCommand(String[] args, ImmutableMap<String, String> env)
    ...
    com.dedalus.bsmr.cd.model.kotlin.BuildKotlinCommand.Builder builder =
        com.dedalus.bsmr.cd.model.kotlin.BuildKotlinCommand.newBuilder();
    ...
    com.dedalus.bsmr.cd.model.kotlin.BuildKotlinCommand proto = builder.build();
    this.buildKotlinCommand =
        BuildKotlinCommand.Companion.fromProto(
            proto.getBuildCommand(), Optional.ofNullable(bsmrScratchPath));
    this.postBuildParams = PostBuildParams.Companion.fromProto(proto.getPostBuildParams());
    this.buildUuid = env.get("BSMR_BUILD_ID");
  ...
  private @Nullable ActionMetadata generateActionMetadata() throws IOException {
    ...
    com.dedalus.bsmr.cd.model.kotlin.ActionMetadata.Builder builder =
        com.dedalus.bsmr.cd.model.kotlin.ActionMetadata.newBuilder();
