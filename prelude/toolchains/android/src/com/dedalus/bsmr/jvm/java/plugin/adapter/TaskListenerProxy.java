...
/**
 * Implements {@link BsmrJavacTaskListener} by proxying calls to an inner {@link TaskListener}. This
 * is the bridge that allows Bsmr to call {@link TaskListener}s that are loaded in the compiler's
 * {@link ClassLoader}.
 */
public class TaskListenerProxy implements BsmrJavacTaskListener {
  private final TaskListener taskListener;

  public TaskListenerProxy(Object taskListener) {
    if (taskListener instanceof BsmrJavacTaskListenerProxy) {
