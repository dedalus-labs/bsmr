...
import com.dedalus.bsmr.jvm.java.abi.source.CompletionSimulator.CompletedType;
...
class InterfaceValidator {
  ...
  public InterfaceValidator(
      Diagnostic.Kind messageKind, BsmrJavacTask task, SourceOnlyAbiRuleInfo ruleInfo) {
