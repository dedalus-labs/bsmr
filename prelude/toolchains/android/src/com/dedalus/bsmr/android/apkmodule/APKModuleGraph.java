...
import com.dedalus.bsmr.core.util.graph.AbstractBreadthFirstTraversal;
import com.dedalus.bsmr.core.util.graph.DirectedAcyclicGraph;
import com.dedalus.bsmr.core.util.graph.MutableDirectedGraph;
import com.dedalus.bsmr.io.file.PathMatcher;
import com.dedalus.bsmr.jvm.java.classes.ClasspathTraversal;
import com.dedalus.bsmr.jvm.java.classes.ClasspathTraverser;
import com.dedalus.bsmr.jvm.java.classes.DefaultClasspathTraverser;
import com.dedalus.bsmr.jvm.java.classes.FileLike;
import com.dedalus.bsmr.util.MoreSuppliers;
...
public class APKModuleGraph<BuildTargetType extends Comparable<BuildTargetType>> {
   ...
   *     depends on <b>m2</b>, it implies to bsmr that in order for <b>m1</b> to be available for
   *     execution <b>m2</b> must be available for use as well. Because of this, we can say that
   *     including a bsmr target in <b>m2</b> effectively includes the bsmr-target in <b>m2's</b>
   *     dependent <b>m1</b>. In other words, <b>m2</b> covers <b>m1</b>. Therefore, if a bsmr
