...
/**
 * This class sets up a separate ClassLoader for most of Bsmr's implementation, leaving only the
 ...
 * not have their classpaths polluted with Bsmr's dependencies when Bsmr is compiling Java code
 * in-process.
 *
 ...
 * descended from the compiler's. If Bsmr used the system ClassLoader as a normal Java application
 * would, this would result in annotation processors getting Bsmr's versions of Guava, Jackson, etc.
