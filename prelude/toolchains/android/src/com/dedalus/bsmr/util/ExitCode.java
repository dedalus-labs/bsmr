...
/**
 * ExitCode class defines Bsmr binary protocol, i.e. exit codes that Bsmr can report to a running
 * shell. In addition to exit codes defined below, we have to honor following conventions.
 *
 * <p>Bsmr bootstrapper must conform to the protocol, i.e. properly implement FATAL_BOOTSTRAP
 *
...
public enum ExitCode {
  ...
  /** Bsmr command completed successfully */
  SUCCESS(0),
  ...
  /** Generic Bsmr-internal non-recoverable error */
  FATAL_GENERIC(10),
  /** Non-recoverable error in Bsmr bootstrapper */
  FATAL_BOOTSTRAP(11),
  ...
  /** Indicates that the bsmr fix script returned a non-zero exit */
  FIX_FAILED(16),
  ...
  /**
   * @return true if error is Bsmr internal non-recoverable failure
   */
