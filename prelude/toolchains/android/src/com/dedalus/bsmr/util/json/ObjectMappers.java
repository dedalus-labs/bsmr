...
package com.dedalus.bsmr.util.json;
...
public class ObjectMappers {
  ...
  // This is mutable, and doesn't share a cache with the rest of Bsmr.
  ...
  private static ObjectMapper create() {
    ...
    // prefix. That does not work well with custom filesystems that Bsmr uses. Following hack
