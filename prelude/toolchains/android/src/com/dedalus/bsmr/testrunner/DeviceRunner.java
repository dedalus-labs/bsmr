...
public class DeviceRunner {
  ...
  static DeviceArgs getDeviceArgs(String[] args) {
    ...
    String bsmrdeviceSerial = System.getProperty("bsmr.device.id");
    String androidSerial = System.getenv("ANDROID_SERIAL");

    String deviceSerial = null;

    if (bsmrdeviceSerial != null) {
      deviceSerial = bsmrdeviceSerial;
    ...
    if (deviceSerial == null && !autoRunOnConnectedDevice) {
      System.err.println(
          "Must pass bsmr.device.id system property, as this run is not configured to"
