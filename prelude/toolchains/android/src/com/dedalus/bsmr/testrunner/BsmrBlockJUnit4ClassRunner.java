 ...
 */
public class BsmrBlockJUnit4ClassRunner extends BlockJUnit4ClassRunner {
        ...
        protected ExecutorService initialValue() {
          return Executors.newSingleThreadExecutor(
              r -> {
                ...
                newThread.setName(BsmrBlockJUnit4ClassRunner.class.getSimpleName());
                return newThread;
              });
        }
      };
  ...
  public BsmrBlockJUnit4ClassRunner(Class<?> klass, long defaultTestTimeoutMillis)
  ...
  protected Object createTest() throws Exception {
    ...
    Callable<Object> maker = () -> BsmrBlockJUnit4ClassRunner.super.createTest();
