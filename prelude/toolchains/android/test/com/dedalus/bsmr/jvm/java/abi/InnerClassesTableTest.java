...
import com.dedalus.bsmr.jvm.java.testutil.compiler.TestCompiler;
...
public class InnerClassesTableTest {
  ...
  public void listsOuterClassesInOrder() throws IOException {
    tester
        ...
        .expectInnerClassesTable(
            "com.example.bsmr.A.B.C.D",
            "com/example/bsmr/A$B",
            "com/example/bsmr/A$B$C",
            "com/example/bsmr/A$B$C$D");
  }
  ...
  public void listsInnerClassesInReverseOrder() throws IOException {
    tester
        ...
        .expectInnerClassesTable(
            "com.example.bsmr.A",
            "com/example/bsmr/A$Inner4",
            "com/example/bsmr/A$Inner3",
            "com/example/bsmr/A$Inner2",
            "com/example/bsmr/A$Inner1");
  }
  ...
  public void listsOuterThenInnerThenReferences() throws IOException {
    tester
        ...
        .expectInnerClassesTable(
            ...
            "com/example/bsmr/A$B$C",
            "com/example/bsmr/A$B$C$D",
            "com/example/bsmr/TopLevel$MemberInterface",
            "com/example/bsmr/TopLevel$MemberInterface2",
            "com/example/bsmr/TopLevel$StaticMember",
            "com/example/bsmr/TopLevel$StaticMember$StaticMemberMember");
  }
  ...
  public void doesNotListInnersOfInnersIfNotReferenced() throws IOException {
    tester
        .setSourceFile(
            ...
            "}")
        .expectInnerClassesTable(
            "com.example.bsmr.A.B", "com/example/bsmr/A$B", "com/example/bsmr/A$B$C");
  }
  ...
  public void includesAllEnclosingClassesForAReferencedType() throws IOException {
    tester
        .setSourceFile(
            "A.java",
            "package com.example.bsmr;",
            "import com.example.bsmr.TopLevel.StaticMember.Inner.*;",
            "public class A {",
            "  Innermost field;",
            "}")
        .expectInnerClassesTable(
            "com.example.bsmr.A",
            "com/example/bsmr/TopLevel$StaticMember",
            "com/example/bsmr/TopLevel$StaticMember$Inner",
            "com/example/bsmr/TopLevel$StaticMember$Inner$Innermost");
  }
  ...
  public void findsInnerClassReferencesInArrays() throws IOException {
    tester
        .setSourceFile(
            ...
            "  TopLevel.StaticMember[] field;",
            "}")
        .expectInnerClassesTable("com.example.bsmr.A", "com/example/bsmr/TopLevel$StaticMember");
  }
  ...
  public void findsInnerClassReferencesInPackageAnnotations() throws IOException {
    tester
        .setSourceFile(
            "package-info.java", "@TopLevel.MemberAnnotation", "package com.example.bsmr;")
        .expectInnerClassesTable(
            "com.example.bsmr.package-info", "com/example/bsmr/TopLevel$MemberAnnotation");
  }
  ...
  public void findsInnerClassReferencesInClassAnnotations() throws IOException {
    tester
        .setSourceFile(
            ...
            "public class A { }")
        .expectInnerClassesTable(
            "com.example.bsmr.A", "com/example/bsmr/TopLevel$MemberAnnotation");
  }
  ...
  public void findsInnerClassReferencesInClassTypeParameterTypeAnnotations() throws IOException {
    tester
        ...
        .expectInnerClassesTable(
            "com.example.bsmr.A", "com/example/bsmr/TopLevel$TypeUseAnnotation");
  }
  ...
  public void findsInnerClassReferencesInMethodThrows() throws IOException {
    tester
        .setSourceFile(
            ...
            "}")
        .expectInnerClassesTable("com.example.bsmr.A", "com/example/bsmr/TopLevel$MemberException");
  }
  ...
  public void findsInnerClassReferencesInAnnotationEnumValues() throws IOException {
    tester
        ...
        .expectInnerClassesTable(
            ...
            "com/example/bsmr/TopLevel$StaticMember",
            "com/example/bsmr/TopLevel$StaticMember$StaticMemberMember",
            "com/example/bsmr/TopLevel$StaticMember$StaticMemberMember$InnerEnum");
  }
  ...
  public void findsInnerClassReferencesInAnnotationAnnotationValues() throws IOException {
    tester
        ...
        .expectInnerClassesTable(
            "com.example.bsmr.A",
            "com/example/bsmr/B$Anno",
            "com/example/bsmr/TopLevel$MemberAnnotation");
  }
  ...
  public void findsInnerClassReferencesInNestedAnnotationAnnotationValues() throws IOException {
    tester
        .setSourceFile(
            "A.java",
            "package com.example.bsmr;",
            "import com.example.bsmr.TopLevel.StaticMember.StaticMemberMember.InnerEnum;",
