  ...
  public void testGetAnnotationWithSingleClass() throws Exception {
    ...
    initCompiler(
        ImmutableMap.of(
            ...
            Joiner.on('\n')
                .join(
                    "@com.dedalus.bsmr.jvm.java.abi.source.AnnotationWithSingleClassForTreeBackedTest(single"
                        + " = Bar.class)",
                    "public class Foo {",
                    "}")));
  ...
  public void testGetAnnotationWithClassArray() throws Exception {
    ...
    initCompiler(
        ImmutableMap.of(
            ...
            Joiner.on('\n')
                .join(
                    "@com.dedalus.bsmr.jvm.java.abi.source.AnnotationWithClassArrayForTreeBackedTest(multi"
                        + " = {Bar.class, Baz.class})",
                    "public class Foo {",
                    "}")));
    testCompiler.setProcessors(
