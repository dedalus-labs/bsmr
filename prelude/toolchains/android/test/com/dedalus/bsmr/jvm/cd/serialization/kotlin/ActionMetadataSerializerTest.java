...
import com.dedalus.bsmr.cd.model.kotlin.Digests;
...
public class ActionMetadataSerializerTest {
  ...
  private static com.dedalus.bsmr.cd.model.kotlin.ActionMetadata createActionMetaData(
    ...
    return com.dedalus.bsmr.cd.model.kotlin.ActionMetadata.newBuilder()
        .setPreviousMetadata(expectedPreviousMetadataBuilder)
        .setCurrentMetadata(expectedCurrentMetadataBuilder)
        .build();
  }

  /** Internal bsmr representation to protocol buffer model */
  private static com.dedalus.bsmr.cd.model.kotlin.Digests serializeDigests(
