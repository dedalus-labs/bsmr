...
public class TreeBackedTypeElementTest extends CompilerTreeApiParameterizedTest {
  ...
  public void testGetQualifiedNameNamedPackage() throws IOException {
    compile(
        String.join(System.lineSeparator(), "package com.dedalus.bsmr;", "public class Foo {}"));

    TypeElement element = elements.getTypeElement("com.dedalus.bsmr.Foo");

    assertNameEquals("com.dedalus.bsmr.Foo", element.getQualifiedName());
  }
  ...
  public void testToString() throws IOException {
    compile(
        String.join(
            System.lineSeparator(), "package com.dedalus.bsmr;", "public class Foo<T> {}"));

    TypeElement element = elements.getTypeElement("com.dedalus.bsmr.Foo");

    assertEquals("com.dedalus.bsmr.Foo", element.toString());
  }
  ...
  public void testGetQualifiedNameInnerClass() throws IOException {
    compile(
        String.join(
            ...
            "package com.dedalus.bsmr;",
            "public class Foo {",
            "  public class Bar { }",
            "}"));

    TypeElement element = elements.getTypeElement("com.dedalus.bsmr.Foo.Bar");

    assertNameEquals("com.dedalus.bsmr.Foo.Bar", element.getQualifiedName());
  }
