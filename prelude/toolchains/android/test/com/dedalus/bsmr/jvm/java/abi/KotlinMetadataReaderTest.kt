...
import com.dedalus.bsmr.jvm.java.abi.kotlin.KotlinMetadataReader
import com.dedalus.bsmr.jvm.kotlin.testutil.compiler.KotlinTestCompiler
...
class KotlinMetadataReaderTest {
  ...
  fun isFilePrivateClass_returnsTrueForPrivateTopLevelClass() {
    val annotation = compileAndGetKotlinMetadata(
        ...
        "com/example/bsmr/PrivateHelper.class",
    )
  ...
  fun isFilePrivateClass_returnsTrueForPrivateObjectDeclaration() {
    val annotation = compileAndGetKotlinMetadata(
        ...
        "com/example/bsmr/PrivateSingleton.class",
    )
  ...
  fun isFilePrivateClass_returnsFalseForPublicClass() {
    val annotation = compileAndGetKotlinMetadata(
        "A.kt",
        arrayOf("package com.example.bsmr", "class PublicClass"),
        "com/example/bsmr/PublicClass.class",
    )
  ...
  fun isFilePrivateClass_returnsFalseForInternalClass() {
    val annotation = compileAndGetKotlinMetadata(
        "A.kt",
        arrayOf("package com.example.bsmr", "internal class InternalClass"),
        "com/example/bsmr/InternalClass.class",
    )
  ...
  fun isFilePrivateClass_returnsFalseForOpenClass() {
    val annotation = compileAndGetKotlinMetadata(
        "A.kt",
        arrayOf("package com.example.bsmr", "open class OpenClass"),
        "com/example/bsmr/OpenClass.class",
    )
  ...
  fun isFilePrivateClass_returnsFalseForPrivateInnerClass() {
    ...
    val annotation = compileAndGetKotlinMetadata(
        ...
        "com/example/bsmr/Outer\$Inner.class",
    )
