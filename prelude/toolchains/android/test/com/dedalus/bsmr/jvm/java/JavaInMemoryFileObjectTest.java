...
import com.dedalus.bsmr.testutil.TestJar;
...
public class JavaInMemoryFileObjectTest {
  ...
  public void testJavaFileName() {
    String relativePath = "com/dedalus/bsmr/java/JavaInMemoryFileObjectTest.class";
    ...
    String expectedName = "com/dedalus/bsmr/java/JavaInMemoryFileObjectTest.class";
  ...
  public void testMultipleJavaFiles() throws Exception {
    String relativePath = "com/dedalus/bsmr/java/JavaFileParser.class";
    JavaInMemoryFileObject file1 =
        new JavaInMemoryFileObject(
            URI.create("file://tmp/" + relativePath), relativePath, JavaFileObject.Kind.CLASS);

    String relativePath2 = "com/dedalus/bsmr/java/JavaLibrary.class";
  ...
  public void testJarURIName() {
    ...
    String expectedName =
        "jar:file:///tmp/test.jar!/com/dedalus/bsmr/java/JavaInMemoryFileObjectTest.class";
