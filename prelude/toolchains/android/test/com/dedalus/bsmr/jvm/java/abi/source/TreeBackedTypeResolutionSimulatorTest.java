...
import com.dedalus.bsmr.jvm.java.abi.source.TreeBackedTypeResolutionSimulator.TreeBackedResolvedType;
...
public class TreeBackedTypeResolutionSimulatorTest extends CompilerTreeApiTest {
  ...
  public void testCanonicalReferenceWithBadClassCasing() throws IOException {
    withClasspath(
        ImmutableMap.of(
            "com/example/bsmr/someclass.java",
            Joiner.on('\n').join("package com.example.bsmr;", "public class someclass { }")));

    compile(
        Joiner.on('\n')
            .join("public class Foo {", "  public com.example.bsmr.someclass field;", "}"));
    assertResolutionResults(
        "com",
        null,
        "com.example",
  ...
  public void testCanonicalReferenceWithBadMemberClassCasingSucceeds() throws IOException {
    ...
    compile(
        Joiner.on('\n')
            .join("public class Foo {", "  public com.example.bsmr.Someclass.inner field;", "}"));
    assertResolutionResults(
        "com",
        null,
        "com.example",
        ...
        "com.example.bsmr.Someclass",
        null,
        "com.example.bsmr.Someclass.inner",
        null);
  }
