...
package com.dedalus.bsmr.jvm.java.lang.model;
...
public class BridgeMethodsTest extends CompilerTreeApiTest {
  ...
  public void testFindsAccessibilityBridgeToPackageType() throws IOException {
    compile(
        ImmutableMap.of(
            ...
            "Subclass.java",
            Joiner.on('\n')
                .join("package com.example.bsmr;", "public class Subclass extends Super { }")));

    TypeElement subclass = elements.getTypeElement("com.example.bsmr.Subclass");
    TypeElement superclass = elements.getTypeElement("com.example.bsmr.Super");
    assertNeededBridges(
        subclass,
        new BridgeMethod(
  ...
  public void testFindsAccessibilityBridgeToPrivateType() throws IOException {
    ...
    TypeElement subclass = elements.getTypeElement("com.example.bsmr.Subclass.Inner");
    TypeElement superclass = elements.getTypeElement("com.example.bsmr.Subclass.InnerSuper");
    assertNeededBridges(
        subclass,
        new BridgeMethod(
            getMethod(superclass, "publicMethod"), getMethod(superclass, "publicMethod")));
  ...
  public void testNoAccessibilityBridgesInNonPublicSubclass() throws IOException {
    compile(
        ImmutableMap.of(
            ...
            "Subclass.java",
            Joiner.on('\n')
                .join("package com.example.bsmr;", "class Subclass extends Super {", "}")));
  ...
  public void testFindsAccessibilityBridgesInSuperSuper() throws IOException {
    compile(
        ImmutableMap.of(
            ...
            "Super.java",
            Joiner.on('\n')
                .join("package com.example.bsmr;", "class Super extends SuperSuper {", "}"),
            "Subclass.java",
            Joiner.on('\n')
                .join("package com.example.bsmr;", "public class Subclass extends Super {", "}")));

    TypeElement subclass = elements.getTypeElement("com.example.bsmr.Subclass");
    TypeElement superclass = elements.getTypeElement("com.example.bsmr.SuperSuper");
    assertNeededBridges(
        subclass,
        new BridgeMethod(
            getMethod(superclass, "publicMethod"), getMethod(superclass, "publicMethod")));
  ...
  public void testNoAccessibilityBridgesWhenSuperclassShouldHaveThem() throws IOException {
    compile(
        ImmutableMap.of(
            ...
            "Super.java",
            Joiner.on('\n')
                .join("package com.example.bsmr;", "public class Super extends SuperSuper {", "}"),
            "Subclass.java",
            Joiner.on('\n')
                .join("package com.example.bsmr;", "public class Subclass extends Super {", "}")));
  ...
  public void testNoAccessibilityBridgesToInterfaceMethods() throws IOException {
    compile(
        ImmutableMap.of(
            ...
            Joiner.on('\n')
                .join(
                    "package com.example.bsmr;", "public class Subclass implements Super {", "}")));
  ...
  public void testFindsBridgesBetweenSuperclassAndInterface() throws IOException {
    ...
    TypeElement subclass = elements.getTypeElement("com.example.bsmr.Subclass");
    TypeElement superclass = elements.getTypeElement("com.example.bsmr.Super");
    TypeElement iface = elements.getTypeElement("com.example.bsmr.Interface");
    assertNeededBridges(
        subclass,
  ...
  public void testAddsBridgesForSuperWhenItIsAnOuterClassOfSubclass() throws IOException {
    ...
    TypeElement subclass = elements.getTypeElement("com.example.bsmr.Super.Subclass");
    TypeElement superclass = elements.getTypeElement("com.example.bsmr.Super");
    TypeElement superSuperClass = elements.getTypeElement("com.example.bsmr.SuperSuper");
    assertNeededBridges(
        subclass,
        new BridgeMethod(
