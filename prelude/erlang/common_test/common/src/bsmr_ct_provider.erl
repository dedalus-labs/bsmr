...
""".
-spec do_init({atom(), init_argument_type()}, #init_provider_state{}) -> bsmr_ct_provider().
...
""".
-spec do_pre_listing(bsmr_ct_provider()) -> bsmr_ct_provider().
...
""".
-spec do_post_listing(bsmr_ct_provider()) -> bsmr_ct_provider().
...
""".
-spec do_pre_running(bsmr_ct_provider()) -> bsmr_ct_provider().
...
""".
-spec do_post_running(bsmr_ct_provider()) -> bsmr_ct_provider().
...
""".
-spec do_terminate(bsmr_ct_provider()) -> bsmr_ct_provider().
