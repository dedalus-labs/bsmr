...
type BsmrConfig struct {
	Preambule             string `json:"preambule"`                // added to the top of each BUILD.bsmr file, e.g. "# Generated by gobuckify"
...
type Config struct {
	Buck        BsmrConfig       `json:"buck"`         // options for BUILD.bsmr files
