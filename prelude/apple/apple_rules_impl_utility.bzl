...
def _apple_bundle_like_common_attrs():
    ...
    attribs = {
        ...
        "_provisioning_profile_sources": attrs.dep(default = "none//xplat/bsmr/platform/apple:provisioning_profile_sources"),
...
def apple_test_extra_attrs():
    ...
    attribs = {
        ...
        "_ipad_simulator": attrs.transition_dep(
            cfg = clear_platform_transition, default = "none//xplat/bsmr/platform/apple:ipad_simulator", providers = [LocalResourceInfo]
        ),
        "_iphone_booted_simulator": attrs.transition_dep(
            cfg = clear_platform_transition, default = "none//xplat/bsmr/platform/apple:iphone_booted_simulator", providers = [LocalResourceInfo]
        ),
        "_iphone_unbooted_simulator": attrs.transition_dep(
            cfg = clear_platform_transition, default = "none//xplat/bsmr/platform/apple:iphone_unbooted_simulator", providers = [LocalResourceInfo]
        ),
        "_swift_enable_testing": attrs.default_only(attrs.bool(default = True)),
        "_watch_simulator": attrs.transition_dep(
            cfg = clear_platform_transition, default = "none//xplat/bsmr/platform/apple:watch_simulator", providers = [LocalResourceInfo]
        ),
