...
# Bessemer Rule Basics - Interactive Tutorial Skill

## Overview

This skill provides an interactive, step-by-step tutorial for learning Bessemer
...
```
User: "Continue the Bessemer tutorial"
...
- Help debug together
- Explain what Bessemer is telling us
...
1. Explore Bessemer's prelude for real production rules
