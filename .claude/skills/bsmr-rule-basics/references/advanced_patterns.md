...
# Advanced Bessemer Rule Patterns

Common patterns and best practices for writing production-ready Bessemer rules.
...
Bessemer's optimized data structure for propagating information up dependency
trees.
...
# bsmr build //:app              # Main executable
# bsmr build //:app[debug]       # Debug symbols
# bsmr build //:app[compdb]      # Compilation database
```
...
These patterns form the building blocks of production Bessemer rules. Combine them
